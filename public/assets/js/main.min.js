var objectFitImages = function() {
    ...
    function g(e) {
        ...
        if (!n.img) {
            n.img = new Image(e.width, e.height), n.img.srcset = c.call(e, "data-ofi-srcset") || e.srcset, n.img.src = c.call(e, "data-ofi-src") || e.src, u.call(e, "data-ofi-src", e.src), e.srcset && u.call(e, "data-ofi-srcset", e.srcset), f(e, e.naturalWidth || e.width, e.naturalHeight || e.height), e.srcset && (e.srcset = "");
            try {
                i = e, o = {
                    get: function(t) {
    ...
    return m.supportsObjectFit = s, m.supportsObjectPosition = n,
        function() {
            function i(t, e) {
...
! function(i) {
    ...
    if (a.window.jarallax = r.default, a.window.jarallax.noConflict = function() {
        ...
        a.jQuery.fn.jarallax = d, a.jQuery.fn.jarallax.noConflict = function() {
    ...
    (function(t) {
        ...
        var u = function(t, e) {
                ...
                if (Symbol.iterator in Object(t)) return function(t, e) {
                    var i = [],
                        ...
                        a = void 0;
                    try {
                        for (var r, s = t[Symbol.iterator](); !(o = (r = s.next()).done) && (i.push(r.value), !e || i.length !== e); o = !0);
                    } catch (t) {
                        n = !0, a = t
                    } finally {
                        try {
        ...
        function f(t) {
            v = n.window.innerWidth || document.documentElement.clientWidth, y = n.window.innerHeight || document.documentElement.clientHeight, "object" !== (void 0 === t ? "undefined" : h(t)) || "load" !== t.type && "dom-loaded" !== t.type || (d = !0)
        }
        ...
        function m() {
            if (p.length) {
                s = void 0 !== n.window.pageYOffset ? n.window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
                var e = d || !g || g.width !== v || g.height !== y,
                    i = c || e || !g || g.y !== s;
                c = d = !1, (e || i) && (p.forEach(function(t) {
        ...
        var b = !!t.ResizeObserver && new t.ResizeObserver(function(t) {
                t && t.length && (0, o.default)(function() {
                    t.forEach(function(t) {
                        t.target && t.target.jarallax && (d || t.target.jarallax.onResize(), c = !0)
                    })
                })
            }),
            x = 0,
            w = function() {
                function c(t, e) {
                    ...
                    d && "object" === (void 0 === d ? "undefined" : h(d)) && void 0 !== d.length && (d = u(d, 1)[0]);
                    d instanceof Element || (d = null), i.options.elementInViewport = d, i.image = {
                ...
                return e(c, [{
                    key: "css",
                    value: function(e, i) {
                        return "string" == typeof i ? n.window.getComputedStyle(e).getPropertyValue(i) : (i.transform && r && (i[r] = i.transform), Object.keys(i).forEach(function(t) {
                            e.style[t] = i[t]
                        }), e)
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        p.forEach(function(t, e) {
                            t.instanceID === i.instanceID && p.splice(e, 1)
                        })
                    }
                }, {
                    key: "destroy",
                    ...
                    value: function() {
                        var t = this,
                            ...
                            r = i,
                            s = 0;
                        return n && (o < 0 ? (a = o * Math.max(i, y), y < i && (a -= o * (i - y))) : a = o * (i + y), 1 < o ? r = Math.abs(a - y) : o < 0 ? r = a / o + Math.abs(a) : r += (y - i) * (1 - o), a /= 2), t.parallaxScrollDistance = a, s = n ? (y - r) / 2 : (i - r) / 2, t.css(t.image.$item, {
                            height: r + "px",
                            marginTop: s + "px",
                    ...
                    value: function(t) {
                        ...
                        if (e.options.elementInViewport && (r = e.options.elementInViewport.getBoundingClientRect()), e.isElementInViewport = 0 <= r.bottom && 0 <= r.right && r.top <= y && r.left <= v, t || e.isElementInViewport) {
                            var s = Math.max(0, o),
                                ...
                                d = Math.max(0, -o),
                                c = Math.max(0, o + n - y),
                                u = Math.max(0, n - (o + n - y)),
                                h = Math.max(0, -o + y - n),
                                f = 1 - 2 * (y - o) / (y + n),
                                p = 1;
                            if (n < y ? p = 1 - (d || c) / n : l <= y ? p = l / y : u <= y && (p = u / y), "opacity" !== e.options.type && "scale-opacity" !== e.options.type && "scroll-opacity" !== e.options.type || (a.transform = "translate3d(0,0,0)", a.opacity = p), "scale" === e.options.type || "scale-opacity" === e.options.type) {
                                var g = 1;
            ...
            k = function(t) {
                ("object" === ("undefined" == typeof HTMLElement ? "undefined" : h(HTMLElement)) ? t instanceof HTMLElement : t && "object" === (void 0 === t ? "undefined" : h(t)) && null !== t && 1 === t.nodeType && "string" == typeof t.nodeName) && (t = [t]);
                for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), o = t.length, n = 0, a = void 0; n < o; n++)
                    if ("object" === (void 0 === e ? "undefined" : h(e)) || void 0 === e ? t[n].jarallax || (t[n].jarallax = new w(t[n], e)) : t[n].jarallax && (a = t[n].jarallax[e].apply(t[n].jarallax, i)), void 0 !== a) return a;
                return t
            };
        k.constructor = w, S.default = k
    }).call(this, C(5))
}, function(t, e, i) {
    "use strict";
    var o = i(4),
...
function(i) {
    ...
    n.default.VideoWorker = n.default.VideoWorker || o.default, (0, r.default)(), (0, a.default)(function() {
        ...
        f = function() {
            function o(t, e) {
                ...
                i.url = t, i.options_default = {
                    ...
                    startTime: 0,
                    endTime: 0
                }, i.options = i.extend({}, i.options_default, e), i.videoID = i.parseURL(t), i.videoID && (i.ID = r++, i.loadAPI(), i.init())
            }
            return a(o, [{
                key: "extend",
                value: function(i) {
                ...
                key: "parseURL",
                value: function(t) {
                    var e, i, o, n, a, r = !(!(e = t.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== e[1].length) && e[1],
                        s = !(!(i = t.match(/https?:\/\/(?:www\.|player\.)?vimeo.com\/(?:channels\/(?:\w+\/)?|groups\/([^\/]*)\/videos\/|album\/(\d+)\/video\/|video\/|)(\d+)(?:$|\/|\?)/)) || !i[3]) && i[3],
                        l = (o = t.split(/,(?=mp4\:|webm\:|ogv\:|ogg\:)/), n = {}, a = 0, o.forEach(function(t) {
                ...
                value: function(e) {
                    var i = this;
                    if (i.videoImage) e(i.videoImage);
                    else {
                        if ("youtube" === i.type) {
                            var t = ["maxresdefault", "sddefault", "hqdefault", "0"],
                                o = 0,
                                n = new Image;
                            n.onload = function() {
                ...
                value: function(l) {
                    var d = this;
                    d.$video ? l(d.$video) : d.onAPIready(function() {
                        var t = void 0;
                        if (d.$video || ((t = document.createElement("div")).style.display = "none"), "youtube" === d.type) {
                            d.playerOptions = {}, d.playerOptions.videoId = d.videoID, d.playerOptions.playerVars = {
                                autohide: 1,
                                rel: 0,
                                autoplay: 0,
                                playsinline: 1
                            }, d.options.showContols || (d.playerOptions.playerVars.iv_load_policy = 3, d.playerOptions.playerVars.modestbranding = 1, d.playerOptions.playerVars.controls = 0, d.playerOptions.playerVars.showinfo = 0, d.playerOptions.playerVars.disablekb = 1);
                            var e = void 0,
                                i = void 0;
                            d.playerOptions.events = {
                                onReady: function(e) {
                                    if (d.options.mute ? e.target.mute() : d.options.volume && e.target.setVolume(d.options.volume), d.options.autoplay && d.play(d.options.startTime), d.fire("ready", e), d.options.loop && !d.options.endTime) {
                                        d.options.endTime = d.player.getDuration() - .1
                                    }
                                    setInterval(function() {
                                        d.getVolume(function(t) {
                                            d.options.volume !== t && (d.options.volume = t, d.fire("volumechange", e))
                                        })
                                    }, 150)
                                },
                                onStateChange: function(t) {
                                    d.options.loop && t.data === YT.PlayerState.ENDED && d.play(d.options.startTime), e || t.data !== YT.PlayerState.PLAYING || (e = 1, d.fire("started", t)), t.data === YT.PlayerState.PLAYING && d.fire("play", t), t.data === YT.PlayerState.PAUSED && d.fire("pause", t), t.data === YT.PlayerState.ENDED && d.fire("ended", t), t.data === YT.PlayerState.PLAYING ? i = setInterval(function() {
                                        d.fire("timeupdate", t), d.options.endTime && d.player.getCurrentTime() >= d.options.endTime && (d.options.loop ? d.play(d.options.startTime) : d.pause())
                                    }, 150) : clearInterval(i)
                                }
                            };
                            var o = !d.$video;
                            if (o) {
                                ...
                                n.setAttribute("id", d.playerID), t.appendChild(n), document.body.appendChild(t)
                            }
                            d.player = d.player || new window.YT.Player(d.playerID, d.playerOptions), o && (d.$video = document.getElementById(d.playerID), d.videoWidth = parseInt(d.$video.getAttribute("width"), 10) || 1280, d.videoHeight = parseInt(d.$video.getAttribute("height"), 10) || 720)
                        }
                        if ("vimeo" === d.type) {
                            if (d.playerOptions = {
                                    id: d.videoID,
                                    autopause: 0,
                                    transparent: 0,
                                    autoplay: d.options.autoplay ? 1 : 0,
                                    loop: d.options.loop ? 1 : 0,
                                    muted: d.options.mute ? 1 : 0
                                }, d.options.volume && (d.playerOptions.volume = d.options.volume), d.options.showContols || (d.playerOptions.badge = 0, d.playerOptions.byline = 0, d.playerOptions.portrait = 0, d.playerOptions.title = 0), !d.$video) {
                                var a = "";
                                Object.keys(d.playerOptions).forEach(function(t) {
                                    "" !== a && (a += "&"), a += t + "=" + encodeURIComponent(d.playerOptions[t])
                                }), d.$video = document.createElement("iframe"), d.$video.setAttribute("id", d.playerID), d.$video.setAttribute("src", "https://player.vimeo.com/video/" + d.videoID + "?" + a), d.$video.setAttribute("frameborder", "0"), d.$video.setAttribute("mozallowfullscreen", ""), d.$video.setAttribute("allowfullscreen", ""), t.appendChild(d.$video), document.body.appendChild(t)
                            }
                            d.player = d.player || new Vimeo.Player(d.$video, d.playerOptions), d.options.startTime && d.options.autoplay && d.player.setCurrentTime(d.options.startTime), d.player.getVideoWidth().then(function(t) {
                                d.videoWidth = t || 1280
                            }), d.player.getVideoHeight().then(function(t) {
                                d.videoHeight = t || 720
                            });
                            var r = void 0;
                            d.player.on("timeupdate", function(t) {
                                r || (d.fire("started", t), r = 1), d.fire("timeupdate", t), d.options.endTime && d.options.endTime && t.seconds >= d.options.endTime && (d.options.loop ? d.play(d.options.startTime) : d.pause())
                            }), d.player.on("play", function(t) {
                                d.fire("play", t), d.options.startTime && 0 === t.seconds && d.play(d.options.startTime)
                            }), d.player.on("pause", function(t) {
                                d.fire("pause", t)
                            }), d.player.on("ended", function(t) {
                                d.fire("ended", t)
                            }), d.player.on("loaded", function(t) {
                                d.fire("ready", t)
                            }), d.player.on("volumechange", function(t) {
                                d.fire("volumechange", t)
                            })
                        }
                        if ("local" === d.type) {
                            d.$video || (d.$video = document.createElement("video"), d.options.showContols && (d.$video.controls = !0), d.options.mute ? d.$video.muted = !0 : d.$video.volume && (d.$video.volume = d.options.volume / 100), d.options.loop && (d.$video.loop = !0), d.$video.setAttribute("playsinline", ""), d.$video.setAttribute("webkit-playsinline", ""), d.$video.setAttribute("id", d.playerID), t.appendChild(d.$video), document.body.appendChild(t), Object.keys(d.videoID).forEach(function(t) {
                                var e, i, o, n;
                                e = d.$video, i = d.videoID[t], o = "video/" + t, (n = document.createElement("source")).src = i, n.type = o, e.appendChild(n)
                            })), d.player = d.player || d.$video;
                            var s = void 0;
                            d.player.addEventListener("playing", function(t) {
                                s || d.fire("started", t), s = 1
                            }), d.player.addEventListener("timeupdate", function(t) {
                                d.fire("timeupdate", t), d.options.endTime && d.options.endTime && this.currentTime >= d.options.endTime && (d.options.loop ? d.play(d.options.startTime) : d.pause())
                            }), d.player.addEventListener("play", function(t) {
                                d.fire("play", t)
                            }), d.player.addEventListener("pause", function(t) {
                                d.fire("pause", t)
                            }), d.player.addEventListener("ended", function(t) {
                                d.fire("ended", t)
                            }), d.player.addEventListener("loadedmetadata", function() {
                                d.videoWidth = this.videoWidth || 1280, d.videoHeight = this.videoHeight || 720, d.fire("ready"), d.options.autoplay && d.play(d.options.startTime)
                            }), d.player.addEventListener("volumechange", function(t) {
                                d.getVolume(function(t) {
                                    d.options.volume = t
                                }), d.fire("volumechange", t)
                            })
                ...
                key: "onAPIready",
                value: function(t) {
                    if ("youtube" === this.type && ("undefined" != typeof YT && 0 !== YT.loaded || d ? "object" === ("undefined" == typeof YT ? "undefined" : n(YT)) && 1 === YT.loaded ? t() : u.done(function() {
                            t()
                        }) : (d = 1, window.onYouTubeIframeAPIReady = function() {
                            window.onYouTubeIframeAPIReady = null, u.resolve("done"), t()
                        })), "vimeo" === this.type)
                        if ("undefined" != typeof Vimeo || c) "undefined" != typeof Vimeo ? t() : h.done(function() {
                            t()
                        });
                        else {
                            c = 1;
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : l.default.jarallax;
        if (void 0 === t) return;
        var e = t.constructor,
            o = e.prototype.init;
        e.prototype.init = function() {
            var i = this;
            o.apply(i), i.video && !i.options.disableVideo() && i.video.getVideo(function(t) {
                var e = t.parentNode;
                i.css(t, {
        ...
        e.prototype.coverImage = function() {
            ...
            if (e && t.video && i && ("IFRAME" === i || "VIDEO" === i)) {
                var o = e.image.height,
                    n = o * t.image.width / t.image.height,
                    a = (e.container.width - n) / 2,
                    r = e.image.marginTop;
                e.container.width > n && (n = e.container.width, o = n * t.image.height / t.image.width, a = 0, r += (e.image.height - o) / 2), "IFRAME" === i && (o += 400, r -= 200), t.css(t.$video, {
                    width: n + "px",
                    marginLeft: a + "px",
                    height: o + "px",
                    marginTop: r + "px"
        ...
        e.prototype.canInitParallax = function() {
            ...
            if (e.isValid())
                if (t) {
                    ...
                    }), !1) : (i.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", !0)
...
! function(t, e) {
    ...
    var s = function(t, e) {
            ...
            if ("IMG" === n) {
                ! function(t, e) {
                    ...
                    if ("PICTURE" === o.tagName)
                        for (var n, a = 0; n = o.children[a]; a += 1)
                            if ("SOURCE" === n.tagName) {
                                var r = s(n, i);
        ...
        h = function(t, e, i) {
            var o, n, a = t.target;
            o = a, n = i.class_loading, r ? o.classList.remove(n) : o.className = o.className.replace(new RegExp("(^|\\s+)" + n + "(\\s+|$)"), " ").replace(/^\s+/, "").replace(/\s+$/, ""), d(a, e ? i.class_loaded : i.class_error), c(e ? i.callback_load : i.callback_error, a)
        },
        f = function(t, e) {
            var i, o, n, a, r, s;
            c(e.callback_enter, t), -1 < ["IMG", "IFRAME"].indexOf(t.tagName) && (o = e, n = function t(e) {
                h(e, !0, o), u(i, t, a)
            }, a = function t(e) {
                h(e, !1, o), u(i, n, t)
            }, (i = t).addEventListener("load", n), i.addEventListener("error", a), d(t, e.class_loading)), l(t, e), r = "was-processed", s = !0, t.setAttribute("data-" + r, s), c(e.callback_set, t)
        },
        e = function(t, e) {
            var i;
            this._settings = (i = {
...
function(t, e) {
    ...
    return function(i) {
        ...
        var n = Object.assign || function(t) {
            ...
            g = function() {
                if (0 < arguments.length && void 0 !== arguments[0] && arguments[0] && (f = !0), f) return h = (0, c.default)(h, p), (0, d.default)(h, p.once), h
            },
            m = function() {
                h = (0, u.default)(), g()
            };
        t.exports = {
            init: function(t) {
                p = n(p, t), h = (0, u.default)();
                var e, i = document.all && !window.atob;
                return !0 === (e = p.disable) || "mobile" === e && l.default.mobile() || "phone" === e && l.default.phone() || "tablet" === e && l.default.tablet() || "function" == typeof e && !0 === e() || i ? void h.forEach(function(t, e) {
                    t.node.removeAttribute("data-aos"), t.node.removeAttribute("data-aos-easing"), t.node.removeAttribute("data-aos-duration"), t.node.removeAttribute("data-aos-delay")
                }) : (p.disableMutationObserver || s.default.isSupported() || (console.info('\n      aos: MutationObserver is not supported on this browser,\n      code mutations observing has been disabled.\n      You may have to call "refreshHard()" by yourself.\n    '), p.disableMutationObserver = !0), document.querySelector("body").setAttribute("data-aos-easing", p.easing), document.querySelector("body").setAttribute("data-aos-duration", p.duration), document.querySelector("body").setAttribute("data-aos-delay", p.delay), "DOMContentLoaded" === p.startEvent && -1 < ["complete", "interactive"].indexOf(document.readyState) ? g(!0) : "load" === p.startEvent ? window.addEventListener(p.startEvent, function() {
                    g(!0)
                }) : document.addEventListener(p.startEvent, function() {
                    g(!0)
                }), window.addEventListener("resize", (0, r.default)(g, p.debounceDelay, !0)), window.addEventListener("orientationchange", (0, r.default)(g, p.debounceDelay, !0)), window.addEventListener("scroll", (0, a.default)(function() {
                    (0, d.default)(h, p.once)
                }, p.throttleDelay)), p.disableMutationObserver || s.default.ready("[data-aos]", m), h)
            },
            refresh: g,
            refreshHard: m
        }
    }, function(t, e) {}, , , , , function(g, t) {
        (function(t) {
            "use strict";
            ...
            function a(o, n, t) {
                function a(t) {
                    var e = d,
                        i = c;
                    return d = c = void 0, g = t, h = o.apply(i, e)
                }
                ...
                function l(t) {
                    return f = void 0, i && d ? a(t) : (d = c = void 0, h)
                }

                function e() {
                    var t, e = S(),
                        i = r(e);
                    if (d = arguments, c = this, p = e, i) {
                ...
                return n = b(n) || 0, y(t) && (m = !!t.leading, u = (v = "maxWait" in t) ? w(b(t.maxWait) || 0, n) : u, i = "trailing" in t ? !!t.trailing : i), e.cancel = function() {
                    void 0 !== f && clearTimeout(f), d = p = c = f = void(g = 0)
                }, e.flush = function() {
            ...
            g.exports = function(t, e, i) {
                ...
                return y(i) && (o = "leading" in i ? !!i.leading : o, n = "trailing" in i ? !!i.trailing : n), a(t, e, {
                    leading: o,
                    maxWait: e,
                    trailing: n
                })
        ...
        (function(t) {
            ...
            function b(t) {
                ...
                t = t.replace(r, "");
                var i = l.test(t);
                return i || d.test(t) ? c(t.slice(2), i ? 2 : 8) : s.test(t) ? n : +t
            }
            var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
                    return typeof t
                } : function(t) {
...
function(t) {
    ...
    n = 0, (r = function(t, e) {
            ...
            for (r = s.options.slidesPerRow * s.options.rows, n = Math.ceil(a.length / r), t = 0; t < n; t++) {
                ...
                for (e = 0; e < s.options.rows; e++) {
                    ...
                    for (i = 0; i < s.options.slidesPerRow; i++) {
                        var c = t * r + (e * s.options.slidesPerRow + i);
        ...
        return t = !0 === r.options.centerMode ? Math.floor(r.$list.width() / 2) : 0, a = -1 * r.swipeLeft + t, !0 === r.options.swipeToSlide ? (r.$slideTrack.find(".slick-slide").each(function(t, e) {
            var i, o;
            if (i = d(e).outerWidth(), o = e.offsetLeft, !0 !== r.options.centerMode && (o += i / 2), a < o + i) return n = e, !1
        }), Math.abs(d(n).attr("data-slick-index") - r.currentSlide) || 1) : r.options.slidesToScroll
        ...
        if (!0 === a.options.centerMode ? !0 === a.options.infinite ? i = (e = a.currentSlide + (a.options.slidesToShow / 2 + 1)) + a.options.slidesToShow + 2 : (e = Math.max(0, a.currentSlide - (a.options.slidesToShow / 2 + 1)), i = a.options.slidesToShow / 2 + 1 + 2 + a.currentSlide) : (e = a.options.infinite ? a.options.slidesToShow + a.currentSlide : a.currentSlide, i = Math.ceil(e + a.options.slidesToShow), !0 === a.options.fade && (0 < e && e--, i <= a.slideCount && i++)), t = a.$slider.find(".slick-slide").slice(e, i), "anticipated" === a.options.lazyLoad)
            for (var n = e - 1, r = i, s = a.$slider.find(".slick-slide"), l = 0; l < a.options.slidesToScroll; l++) n < 0 && (n = a.slideCount - 1), t = (t = t.add(s.eq(n))).add(s.eq(r)), n--, r++;
        ...
        var t, e, i, o, n, a = this,
            r = !1;
        if ("object" === d.type(arguments[0]) ? (i = arguments[0], r = arguments[1], n = "multiple") : "string" === d.type(arguments[0]) && (i = arguments[0], o = arguments[1], r = arguments[2], "responsive" === arguments[0] && "array" === d.type(arguments[1]) ? n = "responsive" : void 0 !== arguments[1] && (n = "single")), "single" === n) a.options[i] = o;
        else if ("multiple" === n) d.each(i, function(t, e) {
            a.options[t] = e
        });
        else if ("responsive" === n)
            for (e in o)
                if ("array" !== d.type(a.options.responsive)) a.options.responsive = [o[e]];
                else {
        ...
        if (e = e || !1, !(!0 === d.animating && !0 === d.options.waitForAnimate || !0 === d.options.fade && d.currentSlide === t))
            if (!1 === e && d.asNavFor(t), o = t, s = d.getLeft(o), r = d.getLeft(d.currentSlide), d.currentLeft = null === d.swipeLeft ? r : d.swipeLeft, !1 === d.options.infinite && !1 === d.options.centerMode && (t < 0 || t > d.getDotCount() * d.options.slidesToScroll)) !1 === d.options.fade && (o = d.currentSlide, !0 !== i && d.slideCount > d.options.slidesToShow ? d.animateSlide(r, function() {
                d.postSlide(o)
            }) : d.postSlide(o));
    ...
    function o(d, n, c) {
        (c = c || e || t.jQuery) && (n.prototype.option || (n.prototype.option = function(t) {
            ...
            if ("string" == typeof t) {
                ...
                return r = e, l = "$()." + d + '("' + (a = t) + '")', (i = this).each(function(t, e) {
                    var i = c.data(e, d);
                    if (i) {
                        var o = i[a];
                        if (o && "_" != a.charAt(0)) {
...
function(t, e) {
    ...
    function S(t) {
        if (function() {
            ...
            var m = v(e.height);
            return !1 !== m && (i.height = m + (p ? 0 : d + f)), i.innerWidth = i.width - (l + h), i.innerHeight = i.height - (d + f), i.outerWidth = i.width + c, i.outerHeight = i.height + u, i
        }
    }
    return S
}),
...
function(t, e) {
    ...
    l.constructor = s, l._create = function() {
        ...
        var t = getComputedStyle(this.element),
            ...
            s = -1 != n.indexOf("%") ? parseFloat(n) / 100 * a.height : parseInt(n, 10);
...
function(n, a) {
    ...
    a.extend(u, e.prototype), u.option = function(t) {
        ...
        this.resize()
    }, a.debounceMethod(c, "onresize", 100), u.resize = function() {
        ...
        var i = h(c);
        return i.defaults = a.extend({}, c.defaults), a.extend(i.defaults, e), i.compatOptions = a.extend({}, c.compatOptions), i.namespace = t, i.data = c.data, i.Item = h(o), a.htmlInit(i, t), s && s.bridget && s.bridget(t, i), i
    };
    var f = {
        ms: 1,
        s: 1e3
...
function(d, s, g, m) {
    "use strict";
    if (g)
        if (g.fn.fancybox) "console" in d && console.log("fancyBox already initialized");
        else {
            var t, e = {
                    loop: !1,
                    margin: [44, 0],
            ...
            g.extend(o.prototype, {
                init: function() {
                    ...
                    o.scrollTop = l.scrollTop(), o.scrollLeft = l.scrollLeft(), g.fancybox.getInstance() || (g("body").addClass("fancybox-active"), /iPad|iPhone|iPod/.test(navigator.userAgent) && !d.MSStream ? "image" !== n.type && g("body").css("top", -1 * g("body").scrollTop()).addClass("fancybox-iosfix") : !g.fancybox.isMobile && s.body.scrollHeight > d.innerHeight && (r === m && (t = g('<div style="width:50px;height:50px;overflow:scroll;" />').appendTo("body"), r = g.fancybox.scrollbarWidth = t[0].offsetWidth - t[0].clientWidth, t.remove()), g("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar { margin-right: ' + r + "px; }</style>"), g("body").addClass("compensate-for-scrollbar"))), i = "", g.each(a.buttons, function(t, e) {
                        i += a.btnTpl[e] || ""
                    }), e = g(o.translate(o, a.baseTpl.replace("{{buttons}}", i).replace("{{arrows}}", a.btnTpl.arrowLeft + a.btnTpl.arrowRight))).attr("id", "fancybox-container-" + o.id).addClass("fancybox-is-hidden").addClass(a.baseClass).data("FancyBox", o).appendTo(a.parentEl), o.$refs = {
                        container: e
                ...
                removeEvents: function() {
                    a.off("orientationchange.fb resize.fb"), l.off("focusin.fb keydown.fb .fb-idle"), this.$refs.container.off(".fb-close .fb-prev .fb-next"), this.idleInterval && (d.clearInterval(this.idleInterval), this.idleInterval = null)
                },
                previous: function(t) {
                ...
                scaleToActual: function(t, e, i) {
                    var o, n, a, r, s, l = this,
                        ...
                        f = d.width,
                        p = d.height;
                    "image" != d.type || d.hasError || !c || l.isAnimating || (g.fancybox.stop(c), l.isAnimating = !0, t = t === m ? .5 * u : t, e = e === m ? .5 * h : e, r = f / (o = g.fancybox.getTranslate(c)).width, s = p / o.height, n = .5 * u - .5 * f, a = .5 * h - .5 * p, u < f && (0 < (n = o.left * r - (t * r - t)) && (n = 0), n < u - f && (n = u - f)), h < p && (0 < (a = o.top * s - (e * s - e)) && (a = 0), a < h - p && (a = h - p)), l.updateCursor(f, p), g.fancybox.animate(c, {
                        top: a,
                        left: n,
                        scaleX: r,
                        scaleY: s
                ...
                getFitPos: function(t) {
                    var e, i, o, n, a, r = t.$content,
                        s = t.width,
                        l = t.height,
                        d = t.opts.margin;
                    return !(!r || !r.length || !s && !l) && ("number" === g.type(d) && (d = [d, d]), 2 == d.length && (d = [d[0], d[1], d[0], d[1]]), e = parseInt(this.$refs.stage.width(), 10) - (d[1] + d[3]), i = parseInt(this.$refs.stage.height(), 10) - (d[0] + d[2]), o = Math.min(1, e / s, i / l), n = Math.floor(o * s), a = Math.floor(o * l), {
                ...
                setImage: function(t) {
                    ...
                    if (r) {
                        o = d.devicePixelRatio || 1, n = d.innerWidth * o, (i = r.split(",").map(function(t) {
                            var o = {};
                ...
                close: function(t, e) {
                    ...
                    return !l.isClosing && (!(l.isClosing = !0) === l.trigger("beforeClose", t) ? (l.isClosing = !1, u(function() {
                        l.update()
                    }), !1) : (l.removeEvents(), d.timouts && clearTimeout(d.timouts), n = d.$content, i = d.opts.animationEffect, o = g.isNumeric(e) ? e : i ? d.opts.animationDuration : 0, d.$slide.off(h).removeClass("fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"), d.$slide.siblings().trigger("onReset").remove(), o && l.$refs.container.removeClass("fancybox-is-open").addClass("fancybox-is-closing"), l.hideLoading(d), l.hideControls(), l.updateCursor(), "zoom" !== i || !0 !== t && n && o && "image" === d.type && !d.hasError && (s = l.getThumbPos(d)) || (i = "fade"), "zoom" === i ? (g.fancybox.stop(n), (r = g.fancybox.getTranslate(n)).width = r.width * r.scaleX, r.height = r.height * r.scaleY, "auto" == (a = d.opts.zoomOpacity) && (a = .1 < Math.abs(d.width / d.height - s.width / s.height)), a && (s.opacity = 0), r.scaleX = r.width / s.width, r.scaleY = r.height / s.height, r.width = s.width, r.height = s.height, g.fancybox.setTranslate(d.$content, r), f(d.$content), g.fancybox.animate(d.$content, s, o, c)) : i && o ? !0 === t ? setTimeout(c, o) : g.fancybox.animate(d.$slide.removeClass("fancybox-slide--current"), "fancybox-animated fancybox-slide--previous fancybox-fx-" + i, o, c) : c(), !0))
                },
                cleanUp: function(t) {
                    var e, i, o = this,
                        n = g("body");
                ...
                use3d: (t = s.createElement("div"), d.getComputedStyle && d.getComputedStyle(t).getPropertyValue("transform") && !(s.documentMode && s.documentMode < 11)),
    ...
    h(document).on("objectNeedsType.fb", function(t, e, n) {
        ...
        i = h.extend(!0, {}, p, n.opts.media), h.each(i, function(t, e) {
            if (r = c.match(e.matcher)) {
                ...
                return s = h.extend(!0, {}, e.params, n.opts[t], d), c = "function" === h.type(e.url) ? e.url.call(this, r, s, n) : f(e.url, r, s), a = "function" === h.type(e.thumb) ? e.thumb.call(this, r, s, n) : f(e.thumb, r), "vimeo" === t && (c = c.replace("&%23", "#")), !1
            }
        }), u ? (n.src = c, n.type = u, n.opts.thumb || n.opts.$thumb && n.opts.$thumb.length || (n.opts.thumb = a), "iframe" === u && (h.extend(!0, n.opts, {
            iframe: {
                preload: !1,
                attr: {
                    scrolling: "no"
        ...
        }), n.contentProvider = o, n.opts.slideClass += " fancybox-slide--video")) : c && (n.type = n.opts.defaultType)
    })
...
function(p, s, g) {
    ...
    i.prototype.destroy = function() {
        ...
        if (!0 !== i) "x" == i && (0 < o.distanceX && (o.instance.group.length < 2 || 0 === o.instance.current.index && !o.instance.current.opts.loop) ? n += Math.pow(o.distanceX, .8) : o.distanceX < 0 && (o.instance.group.length < 2 || o.instance.current.index === o.instance.group.length - 1 && !o.instance.current.opts.loop) ? n -= Math.pow(-o.distanceX, .8) : n += o.distanceX), o.sliderLastPos = {
            ...
            if (o.canTap = !1, o.instance.group.length < 2 && o.opts.vertical ? o.isSwiping = "y" : o.instance.isDragging || !1 === o.opts.vertical || "auto" === o.opts.vertical && 800 < g(p).width() ? o.isSwiping = "x" : (e = Math.abs(180 * Math.atan2(o.distanceY, o.distanceX) / Math.PI), o.isSwiping = 45 < e && e < 135 ? "y" : "x"), o.canTap = !1, "y" === o.isSwiping && g.fancybox.isMobile && (d(o.$target) || d(o.$target.parent()))) return void(o.isScrolling = !0);
        ...
        var t, e, i, o, n, a, r = this,
            ...
            p = u.width,
            g = u.height;
        return n = s < p ? h + d : h, a = f + c, t = Math.max(0, .5 * s - .5 * p), e = Math.max(0, .5 * l - .5 * g), i = Math.min(s - p, .5 * s - .5 * p), o = Math.min(l - g, .5 * l - .5 * g), s < p && (0 < d && t < n && (n = t - 1 + Math.pow(-t + h + d, .8) || 0), d < 0 && n < i && (n = i + 1 - Math.pow(i - h - d, .8) || 0)), l < g && (0 < c && e < a && (a = e - 1 + Math.pow(-e + f + c, .8) || 0), c < 0 && a < o && (a = o + 1 - Math.pow(o - f - c, .8) || 0)), {
            top: a,
            left: n,
            scaleX: u.scaleX,
            scaleY: u.scaleY
        ...
        var t = this,
            ...
            a = y(t.newPoints[0], t.newPoints[1]) / t.startDistanceBetweenFingers,
            r = Math.floor(e * a),
            s = Math.floor(i * a),
            l = (e - r) * t.percentageOfImageAtPinchPointX,
            d = (i - s) * t.percentageOfImageAtPinchPointY,
            c = (t.newPoints[0].x + t.newPoints[1].x) / 2 - g(p).scrollLeft(),
            u = (t.newPoints[0].y + t.newPoints[1].y) / 2 - g(p).scrollTop(),
            h = c - t.centerPointStartX,
            f = {
                top: n + (d + (u - t.centerPointStartY)),
                left: o + (l + h),
        ...
        var e = this,
            ...
            a = e.isZooming,
            r = e.isScrolling;
        if (e.endPoints = c(t), e.$container.removeClass("fancybox-controls--isGrabbing"), g(s).off(".fb.touch"), s.removeEventListener("scroll", e.onscroll, !0), e.requestId && (v(e.requestId), e.requestId = null), e.isSwiping = !1, e.isPanning = !1, e.isZooming = !1, e.isScrolling = !1, e.instance.isDragging = !1, e.canTap) return e.onTap(t);
        ...
        var t, o = this,
            ...
            s = r[0] ? r[0].x - o.$stage.offset().left : 0,
    ...
    s.extend(o.prototype, {
        ...
        create: function() {
            ...
            t.$grid = s('<div class="fancybox-thumbs fancybox-thumbs-' + t.opts.axis + '"></div>').appendTo(e.$refs.container.find(n).addBack().filter(n)), i = "<ul>", s.each(e.group, function(t, e) {
                ...
                var t, e, i, o, n = s(this).parent().removeClass("fancybox-thumbs-loading"),
                    a = n.outerWidth(),
                    r = n.outerHeight();
...
function(a, r, s) {
    ...
    s(function() {
        !1 !== s.fancybox.defaults.hash && (s(a).on({
            "onInit.fb": function(t, e) {
                var i, o;
                !1 !== e.group[e.currIndex].opts.hash && (i = c(), (o = u(e)) && i.gallery && o == i.gallery && (e.currIndex = i.index - 1))
            },
            "beforeShow.fb": function(t, e, i) {
                var o;
                i && !1 !== i.opts.hash && (o = u(e)) && "" !== o && (r.location.hash.indexOf(o) < 0 && (e.opts.origHash = r.location.hash), l = o + (1 < e.group.length ? "-" + (i.index + 1) : ""), "replaceState" in r.history ? (d && clearTimeout(d), d = setTimeout(function() {
                    r.history[n ? "pushState" : "replaceState"]({}, a.title, r.location.pathname + r.location.search + "#" + l), d = null, n = !1
                }, 300)) : r.location.hash = l)
            },
            "beforeClose.fb": function(t, e, i) {
                var o, n;
                d && clearTimeout(d), !1 !== i.opts.hash && (o = u(e), n = e && e.opts.origHash ? e.opts.origHash : "", o && "" !== o && ("replaceState" in history ? r.history.replaceState({}, a.title, r.location.pathname + r.location.search + n) : (r.location.hash = n, s(r).scrollTop(e.scrollTop).scrollLeft(e.scrollLeft))), l = null)
            }
...
function(s) {
    ...
    s.fn.showclock = function() {
        var t = new Date,
            e = s(this).data("date").split("-"),
            i = new Date(e[0], e[1] - 1, e[2]).getTime() / 1e3 - t.getTime() / 1e3;
        ...
        return function a(r, s, l) {
            ...
            2: [function(t, e, i) {
                ...
                function o(t) {
                    if (t) {
                        ...
                        for (n = 0; n < e.length; n++) e[n] = c(e[n], 0, 255);
            ...
            3: [function(t, e, i) {
                ...
                r.prototype = {
                    ...
                    for (var d in a) d !== t && (n[d] = c[t][d](n[t]));
                    return !0
            ...
            4: [function(t, e, i) {
                ...
                function u(t) {
                    var e, i, o, n, a, r = t[0] / 360,
                        s = t[1] / 100,
                        l = t[2] / 100;
                    if (0 == s) return [a = 255 * l, a, a];
                    e = 2 * l - (i = l < .5 ? l * (1 + s) : l + s - l * s), n = [0, 0, 0];
                    for (var d = 0; d < 3; d++)(o = r + 1 / 3 * -(d - 1)) < 0 && o++, 1 < o && o--, a = 6 * o < 1 ? e + 6 * (i - e) * o : 2 * o < 1 ? i : 3 * o < 2 ? e + (i - e) * (2 / 3 - o) * 6 : e, n[d] = 255 * a;
                    return n
                }
                ...
                function f(t) {
                    var e, i, o, n, a = t[0] / 360,
                        s = t[1] / 100,
                        l = t[2] / 100,
                        d = s + l;
                    switch (1 < d && (s /= d, l /= d), o = 6 * a - (e = Math.floor(6 * a)), 0 != (1 & e) && (o = 1 - o), n = s + o * ((i = 1 - l) - s), e) {
                        default:
                            case 6:
                            case 0:
                            r = i,
                    ...
                    e.controllers.bar = e.DatasetController.extend({
                        ...
                        updateElementGeometry: function(t, e, i) {
                            var o = this,
                                ...
                                d = o.calculateBarValuePixels(o.index, e),
                                c = o.calculateBarIndexPixels(o.index, e, l);
                            n.horizontal = s, n.base = i ? r : d.base, n.x = s ? i ? r : d.head : c.center, n.y = s ? c.center : i ? r : d.head, n.height = s ? c.size : void 0, n.width = s ? void 0 : c.size
                        },
                        ...
                        getStackCount: function(t) {
                            var e, i, o = this.chart,
                                n = this.getIndexScale().options.stacked,
                        ...
                        calculateBarValuePixels: function(t, e) {
                            var i, o, n, a, r, s, l = this.chart,
                                d = this.getMeta(),
                                c = this.getValueScale(),
                                u = l.data.datasets,
                                h = c.getRightValue(u[t].data[e]),
                                f = c.options.stacked,
                                p = d.stack,
                                g = 0;
                            if (f || void 0 === f && void 0 !== p)
                                for (i = 0; i < t; ++i)(o = l.getDatasetMeta(i)).bar && o.stack === p && o.controller.getValueScaleId() === c.id && l.isDatasetVisible(i) && (n = c.getRightValue(u[i].data[e]), (h < 0 && n < 0 || 0 <= h && 0 < n) && (g += n));
                            return a = c.getPixelForValue(g), {
                                size: s = ((r = c.getPixelForValue(g + h)) - a) / 2,
                                base: a,
                                head: r,
                                center: r + s / 2
                            }
                        ...
                        calculateBarIndexPixels: function(t, e, i) {
                            var o, n, a, r, s, l = i.scale.options,
                                ...
                                f = i.start,
                                p = i.end;
                            return 1 === h ? (o = f < u ? u - f : p - u, n = u < p ? p - u : u - f) : (0 < e && (o = (u - c[e - 1]) / 2, e === h - 1 && (n = o)), e < h - 1 && (n = (c[e + 1] - u) / 2, 0 === e && (o = n))), s = (r = ((a = o * l.categoryPercentage) + n * l.categoryPercentage) / i.stackCount) * l.barPercentage, u -= a, u += r * d, {
                    ...
                    t.controllers.bubble = t.DatasetController.extend({
                        ...
                        updateElement: function(t, e, i) {
                            var o = this,
                                n = o.getMeta(),
                                a = t.custom || {},
                                r = o.getScaleForId(n.xAxisID),
                                s = o.getScaleForId(n.yAxisID),
                                l = o._resolveElementOptions(t, e),
                                d = o.getDataset().data[e],
                                c = o.index,
                                u = i ? r.getPixelForDecimal(.5) : r.getPixelForValue("object" == typeof d ? d : NaN, e, c),
                                h = i ? s.getBasePixel() : s.getPixelForValue(d, e, c);
                            t._xScale = r, t._yScale = s, t._options = l, t._datasetIndex = c, t._index = e, t._model = {
                        ...
                        _resolveElementOptions: function(t, e) {
                            ...
                            for (i = 0, o = f.length; i < o; ++i) u[n = f[i]] = d([s[n], r[n], l[n]], h, e);
                            return u.radius = d([s.radius, c ? c.r : void 0, r.radius, l.radius], h, e), u
                        }
                    })
                }
            }, {
                ...
                o._set("doughnut", {
                    ...
                    legendCallback: function(t) {
                        ...
                        var i = t.data,
                            ...
                            n = i.labels;
                        if (o.length)
                            for (var a = 0; a < o[0].data.length; ++a) e.push('<li><span style="background-color:' + o[0].backgroundColor[a] + '"></span>'), n[a] && e.push(n[a]), e.push("</li>");
                        ...
                        callbacks: {
                            ...
                            label: function(t, e) {
                                var i = e.labels[t.index],
                                    o = ": " + e.datasets[t.datasetIndex].data[t.index];
                                return I.isArray(i) ? (i = i.slice())[0] += o : i += o, i
                            }
                        }
                    }
                }), o._set("pie", I.clone(o.doughnut)), o._set("pie", {
                    cutoutPercentage: 0
                }), e.exports = function(e) {
                    e.controllers.doughnut = e.controllers.pie = e.DatasetController.extend({
                        ...
                        update: function(i) {
                            var o = this,
                                ...
                                n = t.options,
                                a = n.elements.arc,
                                r = e.right - e.left - a.borderWidth,
                            ...
                            if (h < 2 * Math.PI) {
                                var f = n.rotation % (2 * Math.PI),
                                    ...
                                    M = b ? 1 : Math.max(g * (0 < g ? 1 : S), v * (0 < v ? 1 : S)),
                                    _ = x ? 1 : Math.max(m * (0 < m ? 1 : S), y * (0 < y ? 1 : S)),
                                    P = .5 * (M - C),
                                    A = .5 * (_ - T);
                                l = Math.min(r / P, s / A), d = {
                                    x: -.5 * (M + C),
                                    y: -.5 * (_ + T)
                                }
                            }
                            t.borderWidth = o.getMaxBorderWidth(c.data), t.outerRadius = Math.max((l - t.borderWidth) / 2, 0), t.innerRadius = Math.max(u ? t.outerRadius / 100 * u : 0, 0), t.radiusLength = (t.outerRadius - t.innerRadius) / t.getVisibleDatasetCount(), t.offsetX = d.x * t.outerRadius, t.offsetY = d.y * t.outerRadius, c.total = o.calculateTotal(), o.outerRadius = t.outerRadius - t.radiusLength * o.getRingIndex(o.index), o.innerRadius = Math.max(o.outerRadius - t.radiusLength, 0), I.each(c.data, function(t, e) {
                                o.updateElement(t, e, i)
                            })
                        },
                        updateElement: function(t, e, i) {
                            var o = this,
                                ...
                                u = r.rotation,
                                h = o.getDataset(),
                                f = i && s.animateRotate ? 0 : t.hidden ? 0 : o.calculateCircumference(h.data[e]) * (r.circumference / (2 * Math.PI)),
                                p = i && s.animateScale ? 0 : o.innerRadius,
                                g = i && s.animateScale ? 0 : o.outerRadius,
                        ...
                        calculateTotal: function() {
                            var i, o = this.getDataset(),
                                t = this.getMeta(),
                                n = 0;
                            return I.each(t.data, function(t, e) {
                    ...
                    t.controllers.line = t.DatasetController.extend({
                        ...
                        update: function(t) {
                            var e, i, o, n = this,
                                ...
                                l = n.chart.options,
                                d = l.elements.line,
                                c = n.getScaleForId(a.yAxisID),
                                u = n.getDataset(),
                                h = f(u, l);
                            for (h && (o = r.custom || {}, void 0 !== u.tension && void 0 === u.lineTension && (u.lineTension = u.tension), r._scale = c, r._datasetIndex = n.index, r._children = s, r._model = {
                                    spanGaps: u.spanGaps ? u.spanGaps : l.spanGaps,
                                    tension: o.tension ? o.tension : p.valueOrDefault(u.lineTension, d.tension),
                                    backgroundColor: o.backgroundColor ? o.backgroundColor : u.backgroundColor || d.backgroundColor,
                                    borderWidth: o.borderWidth ? o.borderWidth : u.borderWidth || d.borderWidth,
                                    borderColor: o.borderColor ? o.borderColor : u.borderColor || d.borderColor,
                                    borderCapStyle: o.borderCapStyle ? o.borderCapStyle : u.borderCapStyle || d.borderCapStyle,
                                    borderDash: o.borderDash ? o.borderDash : u.borderDash || d.borderDash,
                                    borderDashOffset: o.borderDashOffset ? o.borderDashOffset : u.borderDashOffset || d.borderDashOffset,
                                    borderJoinStyle: o.borderJoinStyle ? o.borderJoinStyle : u.borderJoinStyle || d.borderJoinStyle,
                                    fill: o.fill ? o.fill : void 0 !== u.fill ? u.fill : d.fill,
                                    steppedLine: o.steppedLine ? o.steppedLine : p.valueOrDefault(u.steppedLine, d.stepped),
                                    cubicInterpolationMode: o.cubicInterpolationMode ? o.cubicInterpolationMode : p.valueOrDefault(u.cubicInterpolationMode, d.cubicInterpolationMode)
                        ...
                        updateElement: function(t, e, i) {
                            var o, n, a = this,
                                ...
                                h = a.getScaleForId(r.xAxisID),
                                f = a.chart.options.elements.point;
                            void 0 !== l.radius && void 0 === l.pointRadius && (l.pointRadius = l.radius), void 0 !== l.hitRadius && void 0 === l.pointHitRadius && (l.pointHitRadius = l.hitRadius), o = h.getPixelForValue("object" == typeof c ? c : NaN, e, d), n = i ? u.getBasePixel() : a.calculatePointY(c, e, d), t._xScale = h, t._yScale = u, t._datasetIndex = d, t._index = e, t._model = {
                                x: o,
                                y: n,
                        ...
                        calculatePointY: function(t, e, i) {
                            ...
                            if (l.options.stacked) {
                                for (o = 0; o < i; o++)
                                    if (n = r.data.datasets[o], "line" === (a = r.getDatasetMeta(o)).type && a.yAxisID === l.id && r.isDatasetVisible(o)) {
                        ...
                        updateBezierControlPoints: function() {
                            ...
                            if (n.dataset._model.spanGaps && (r = r.filter(function(t) {
                                ...
                                })), "monotone" === n.dataset._model.cubicInterpolationMode) p.splineCurveMonotone(r);
                            else
                                for (t = 0, e = r.length; t < e; ++t) i = r[t]._model, o = p.splineCurve(p.previousItem(r, t)._model, i, p.nextItem(r, t)._model, n.dataset._model.tension), i.controlPointPreviousX = o.previous.x, i.controlPointPreviousY = o.previous.y, i.controlPointNextX = o.next.x, i.controlPointNextY = o.next.y;
                            if (this.chart.options.elements.line.capBezierPoints)
                                for (t = 0, e = r.length; t < e; ++t)(i = r[t]._model).controlPointPreviousX = s(i.controlPointPreviousX, a.left, a.right), i.controlPointPreviousY = s(i.controlPointPreviousY, a.top, a.bottom), i.controlPointNextX = s(i.controlPointNextX, a.left, a.right), i.controlPointNextY = s(i.controlPointNextY, a.top, a.bottom)
                        },
                        draw: function() {
                            var t = this.chart,
                                e = this.getMeta(),
            ...
            19: [function(t, e, i) {
                ...
                o._set("polarArea", {
                    ...
                    e.controllers.polarArea = e.DatasetController.extend({
                        ...
                        updateElement: function(t, e, i) {
                            for (var o = this, n = o.chart, a = o.getDataset(), r = n.options, s = r.animation, l = n.scale, d = n.data.labels, c = o.calculateCircumference(a.data[e]), u = l.xCenter, h = l.yCenter, f = 0, p = o.getMeta(), g = 0; g < e; ++g) isNaN(a.data[g]) || p.data[g].hidden || ++f;
                            var m = r.startAngle,
                            ...
                            w.extend(t, {
                                ...
                                _model: {
                                    ...
                                    innerRadius: 0,
                                    outerRadius: i ? x : v,
                                    startAngle: i && s.animateRotate ? m : y,
                                    endAngle: i && s.animateRotate ? m : b,
                    ...
                    t.controllers.radar = t.DatasetController.extend({
                        ...
                        update: function(i) {
                            var o = this,
                                ...
                                a = e.custom || {},
                                r = o.getDataset(),
                                s = o.chart.options.elements.line,
                                l = o.chart.scale;
                            void 0 !== r.tension && void 0 === r.lineTension && (r.lineTension = r.tension), d.extend(t.dataset, {
                                _datasetIndex: o.index,
                                _scale: l,
                                _children: n,
                                _loop: !0,
                                _model: {
                                    tension: a.tension ? a.tension : d.valueOrDefault(r.lineTension, s.tension),
                            ...
                            }), t.dataset.pivot(), d.each(n, function(t, e) {
                                o.updateElement(t, e, i)
                        ...
                        updateElement: function(t, e, i) {
                            var o = this,
                                ...
                                a = o.getDataset(),
                                r = o.chart.scale,
                                s = o.chart.options.elements.point,
                                l = r.getPointPositionForValue(e, a.data[e]);
                            void 0 !== a.radius && void 0 === a.pointRadius && (a.pointRadius = a.radius), void 0 !== a.hitRadius && void 0 === a.pointHitRadius && (a.pointHitRadius = a.hitRadius), d.extend(t, {
                                _datasetIndex: o.index,
                                _index: e,
                                _scale: r,
                                _model: {
                                    x: i ? r.xCenter : l.x,
                                    y: i ? r.yCenter : l.y,
                                    tension: n.tension ? n.tension : d.valueOrDefault(a.lineTension, o.chart.options.elements.line.tension),
                                    radius: n.radius ? n.radius : d.valueAtIndexOrDefault(a.pointRadius, e, s.radius),
                                    backgroundColor: n.backgroundColor ? n.backgroundColor : d.valueAtIndexOrDefault(a.pointBackgroundColor, e, s.backgroundColor),
                                    borderColor: n.borderColor ? n.borderColor : d.valueAtIndexOrDefault(a.pointBorderColor, e, s.borderColor),
                                    borderWidth: n.borderWidth ? n.borderWidth : d.valueAtIndexOrDefault(a.pointBorderWidth, e, s.borderWidth),
                                    pointStyle: n.pointStyle ? n.pointStyle : d.valueAtIndexOrDefault(a.pointStyle, e, s.pointStyle),
                                    hitRadius: n.hitRadius ? n.hitRadius : d.valueAtIndexOrDefault(a.pointHitRadius, e, s.hitRadius)
                                }
                        ...
                        updateBezierControlPoints: function() {
                            var n = this.chart.chartArea,
                                a = this.getMeta();
                            d.each(a.data, function(t, e) {
                                var i = t._model,
                                    o = d.splineCurve(d.previousItem(a.data, e, !0)._model, i, d.nextItem(a.data, e, !0)._model, i.tension);
                ...
                o._set("global", {
                    ...
                    t.Animation = n.extend({
                        ...
                        addAnimation: function(t, e, i, o) {
                            ...
                            for (e.chart = t, o || (t.animating = !0), n = 0, a = r.length; n < a; ++n)
                                if (r[n].chart === t) return void(r[n] = e);
            ...
            23: [function(t, e, i) {
                ...
                e.exports = function(d) {
                    ...
                    d.types = {}, d.instances = {}, d.controllers = {}, u.extend(d.prototype, {
                        construct: function(t, e) {
                            var i, o, n = this;
                            (o = (i = (i = e) || {}).data = i.data || {}).datasets = o.datasets || [], o.labels = o.labels || [], i.options = u.configMerge(c.global, c[i.type], i.options || {}), e = i;
                            var a = h.acquireContext(t, e),
                                r = a && a.canvas,
                                s = r && r.height,
                                l = r && r.width;
                            n.id = u.uid(), n.ctx = a, n.canvas = r, n.config = e, n.width = l, n.height = s, n.aspectRatio = s ? l / s : null, n.options = e.options, n._bufferedRender = !1, (n.chart = n).controller = n, d.instances[n.id] = n, Object.defineProperty(n, "data", {
                                get: function() {
                        ...
                        resize: function(t) {
                            var e = this,
                                ...
                                a = Math.max(0, Math.floor(u.getMaximumWidth(o))),
                                r = Math.max(0, Math.floor(n ? a / n : u.getMaximumHeight(o)));
                        ...
                        buildScales: function() {
                            ...
                            t.scales && (e = e.concat((t.scales.xAxes || []).map(function(t) {
                                ...
                                var e = t.options,
                                    i = u.valueOrDefault(e.type, t.dtype),
                                    o = d.scaleService.getScaleConstructor(i);
                                if (o) {
                        ...
                        buildOrUpdateControllers: function() {
                            ...
                            return u.each(a.data.datasets, function(t, e) {
                                var i = a.getDatasetMeta(e),
                                    o = t.type || a.config.type;
                                if (i.type && i.type !== o && (a.destroyDatasetMeta(e), i = a.getDatasetMeta(e)), i.type = o, r.push(i.type), i.controller) i.controller.updateIndex(e);
                                else {
                                    var n = d.controllers[i.type];
                        ...
                        updateLayout: function() {
                            !1 !== l.notify(this, "beforeLayout") && (d.layoutService.update(this, this.width, this.height), l.notify(this, "afterScaleUpdate"), l.notify(this, "afterLayout"))
                        },
                        ...
                        render: function(t) {
                            ...
                            if (!1 !== l.notify(e, "beforeRender")) {
                                ...
                                if (n && (void 0 !== i && 0 !== i || void 0 === i && 0 !== n.duration)) {
                                    var r = new d.Animation({
                                        numSteps: (i || n.duration) / 16.66,
                                        easing: t.easing || n.easing,
                                        render: function(t, e) {
                                            var i = u.easing.effects[e.easing],
                                                o = e.currentStep,
                                                n = o / e.numSteps;
                                            t.draw(i(n), n, o)
                                        },
                                    ...
                                    d.animationService.addAnimation(e, r, i, o)
                                } else e.draw(), a(new d.Animation({
                                    numSteps: 0,
                                    chart: e
                                }));
                                return e
                        ...
                        getElementsAtEvent: function(t) {
                            return n.modes.label(this, t, {
                                intersect: !0
                            })
                        },
                        getElementsAtXAxis: function(t) {
                            return n.modes["x-axis"](this, t, {
                                intersect: !0
                            })
                        },
                        ...
                        destroy: function() {
                            ...
                            o && (i.unbindEvents(), u.canvas.clear(i), h.releaseContext(i.ctx), i.canvas = null, i.ctx = null), l.notify(i, "destroy"), delete d.instances[i.id]
                        },
                        toBase64Image: function() {
                            return this.canvas.toDataURL.apply(this.canvas, arguments)
                        },
                        initToolTip: function() {
                            this.tooltip = new d.Tooltip({
                                _chart: this,
                                _chartInstance: this,
                                _data: this.data,
            ...
            24: [function(t, e, i) {
                ...
                e.exports = function(t) {
                    ...
                    function o(e, t) {
                        ...
                        if (i) {
                            var o = i.listeners,
                                n = o.indexOf(t); - 1 !== n && o.splice(n, 1), 0 < o.length || (a.forEach(function(t) {
                                delete e[t]
                            }), delete e._chartjs)
                        }
                    }
                    t.DatasetController = function(t, e) {
                        ...
                        buildOrUpdateElements: function() {
                            var n, t, e = this.getDataset(),
                                i = e.data || (e.data = []);
                            this._data !== i && (this._data && o(this._data, this), t = this, (n = i)._chartjs ? n._chartjs.listeners.push(t) : (Object.defineProperty(n, "_chartjs", {
                                configurable: !0,
                                enumerable: !1,
                                value: {
                                    listeners: [t]
            ...
            26: [function(t, e, i) {
                ...
                o.extend(n.prototype, {
                    ...
                    pivot: function() {
                        return this._view || (this._view = o.clone(this._model)), this._start = {}, this
                    },
                    transition: function(t) {
                        var e = this._model,
                            i = this._start,
                            o = this._view;
                        return e && 1 !== t ? (o || (o = this._view = {}), i || (i = this._start = {}), function(t, e, i, o) {
                            var n, a, r, s, l, d, c, u, h, f = Object.keys(i);
                            for (n = 0, a = f.length; n < a; ++n)
                                if (d = i[r = f[n]], e.hasOwnProperty(r) || (e[r] = d), (s = e[r]) !== d && "_" !== r[0]) {
                                    if (t.hasOwnProperty(r) || (t[r] = s), (c = typeof d) == typeof(l = t[r]))
                                        if ("string" === c) {
                                            if ((u = p(l)).valid && (h = p(d)).valid) {
                                                e[r] = h.mix(u, o).rgbString();
                                                continue
                                            }
                                        } else if ("number" === c && isFinite(l) && isFinite(d)) {
                                        e[r] = l + (d - l) * o;
                                        continue
                                    }
                                    e[r] = d
                                }
                        }(i, o, e, t)) : (this._view = e, this._start = null), this
                    },
                ...
                e.exports = function(l) {
                    ...
                    function e(t, e, i) {
                        var o = document.defaultView,
                            n = t.parentNode,
                            a = o.getComputedStyle(t)[e],
                            r = o.getComputedStyle(n)[e],
                            s = u(a),
                            l = u(r),
                            d = Number.POSITIVE_INFINITY;
                        return s || l ? Math.min(s ? c(a, t, i) : d, l ? c(r, n, i) : d) : "none"
                    }
                    p.configMerge = function() {
                        ...
                        var n = t.skip ? e : t,
                            a = e,
                            r = i.skip ? e : i,
                            s = Math.sqrt(Math.pow(a.x - n.x, 2) + Math.pow(a.y - n.y, 2)),
                        ...
                        var e, i, o, n, a, r, s, l, d, c = (t || []).map(function(t) {
                                return {
                                    model: t._model,
                                    deltaK: 0,
                                    mK: 0
                        ...
                        for (e = 0; e < u; ++e)
                            if (!(o = c[e]).model.skip) {
                                if (i = 0 < e ? c[e - 1] : null, (n = e < u - 1 ? c[e + 1] : null) && !n.model.skip) {
                        ...
                        for (e = 0; e < u - 1; ++e) o = c[e], n = c[e + 1], o.model.skip || n.model.skip || (p.almostEquals(o.deltaK, 0, this.EPSILON) ? o.mK = n.mK = 0 : (a = o.mK / o.deltaK, r = n.mK / o.deltaK, (l = Math.pow(a, 2) + Math.pow(r, 2)) <= 9 || (s = 3 / Math.sqrt(l), o.mK = a * s * o.deltaK, n.mK = r * s * o.deltaK)));
                        for (e = 0; e < u; ++e)(o = c[e]).model.skip || (i = 0 < e ? c[e - 1] : null, n = e < u - 1 ? c[e + 1] : null, i && !i.model.skip && (d = (o.model.x - i.model.x) / 3, o.model.controlPointPreviousX = o.model.x - d, o.model.controlPointPreviousY = o.model.y - d * o.mK), n && !n.model.skip && (d = (n.model.x - o.model.x) / 3, o.model.controlPointNextX = o.model.x + d, o.model.controlPointNextY = o.model.y + d * o.mK))
                        ...
                        var l = parseFloat(p.getStyle(a, "padding-left")),
                            d = parseFloat(p.getStyle(a, "padding-top")),
                            c = parseFloat(p.getStyle(a, "padding-right")),
                            u = parseFloat(p.getStyle(a, "padding-bottom")),
                            h = r.right - r.left - l - c,
                            f = r.bottom - r.top - d - u;
                        return {
                            x: i = Math.round((i - r.left - l) / h * a.width / e.currentDevicePixelRatio),
                            y: o = Math.round((o - r.top - d) / f * a.height / e.currentDevicePixelRatio)
                        }
                        ...
                        var i = parseInt(p.getStyle(e, "padding-left"), 10),
                            o = parseInt(p.getStyle(e, "padding-right"), 10),
                            n = e.clientWidth - i - o,
                        ...
                        var i = parseInt(p.getStyle(e, "padding-top"), 10),
                            o = parseInt(p.getStyle(e, "padding-bottom"), 10),
                        ...
                        var n = (o = o || {}).data = o.data || {},
                            a = o.garbageCollect = o.garbageCollect || [];
            ...
            28: [function(t, e, i) {
                ...
                function l(t, e) {
                    var i, o, n, a, r;
                    for (o = 0, a = t.data.datasets.length; o < a; ++o)
                        if (t.isDatasetVisible(o))
                            for (n = 0, r = (i = t.getDatasetMeta(o)).data.length; n < r; ++n) {
                                var s = i.data[n];
                                s._view.skip || e(s)
                            }
                }
                        ...
                        update: function(e, i, t) {
                            if (e) {
                                var o = e.options.layout || {},
                                    n = W.options.toPadding(o.padding),
                                    a = n.left,
                                    r = n.right,
                                    s = n.top,
                                    l = n.bottom,
                                    ...
                                    u = R(e.boxes, "top"),
                                    h = R(e.boxes, "bottom"),
                                    f = R(e.boxes, "chartArea");
                                j(d, !0), j(c, !1), j(u, !0), j(h, !1);
                                var p = i - a - r,
                                    g = t - s - l,
                                    m = g / 2,
                                    v = (i - p / 2) / (d.length + c.length),
                                    y = (t - m) / (u.length + h.length),
                                    b = p,
                                    x = g,
                                    w = [];
                                W.each(d.concat(c, u, h), function(t) {
                                    var e, i = t.isHorizontal();
                                    i ? (e = t.update(t.fullWidth ? p : b, y), x -= e.height) : (e = t.update(v, m), b -= e.width), w.push({
                                        horizontal: i,
                                        minSize: e,
                                        box: t
                                    })
                                ...
                                var M = a,
                                    ...
                                    P = s,
                                    A = l;
                                W.each(d.concat(c), z), W.each(d, function(t) {
                                    M += t.width
                                }), W.each(c, function(t) {
                                    _ += t.width
                                ...
                                }), M = a, _ = r, P = s, A = l, W.each(d, function(t) {
                                    M += t.width
                                }), W.each(c, function(t) {
                                    _ += t.width
                                }), W.each(u, function(t) {
                                ...
                                var I = Math.max(k - M, 0);
                                M += I, _ += Math.max(S - _, 0);
                                var $ = Math.max(C - P, 0);
                                P += $, A += Math.max(T - A, 0);
                                var D = t - P - A,
                                    O = i - M - _;
                                O === b && D === x || (W.each(d, function(t) {
                                    t.height = D
                                }), W.each(c, function(t) {
                                    t.height = D
                                }), W.each(u, function(t) {
                                ...
                                var L = a + I,
                                    E = s + $;
                                W.each(d.concat(u), F), L += b, E += x, W.each(c, F), W.each(h, F), e.chartArea = {
                                    left: M,
                                    top: P,
                                    right: M + b,
                                    bottom: P + x
                            ...
                            function z(e) {
                                ...
                                if (t)
                                    if (e.isHorizontal()) {
                                        ...
                                        e.update(e.fullWidth ? p : b, g / 2, i)
                                    } else e.update(t.minSize.width, x)
                            }

                            function F(t) {
                                t.isHorizontal() ? (t.left = t.fullWidth ? a : M, t.right = t.fullWidth ? i - r : M + b, t.top = E, t.bottom = E + t.height, E = t.bottom) : (t.left = L, t.right = L + t.width, t.top = P, t.bottom = P + x, L = t.right)
                            }
                        }
                    }
                }
                ...
                r._set("global", {
                    ...
                    t.plugins = {
                        ...
                        notify: function(t, e, i) {
                            var o, n, a, r, s, l = this.descriptors(t),
                                d = l.length;
                            for (o = 0; o < d; ++o)
                                if ("function" == typeof(s = (a = (n = l[o]).plugin)[e]) && ((r = [t].concat(i || [])).push(n.options), !1 === s.apply(a, r))) return !1;
                            return !0
                        },
                ...
                x._set("scale", {
                    ...
                    t.Scale = o.extend({
                        ...
                        update: function(t, e, i) {
                            var o, n, a, r, s, l, d = this;
                            for (d.beforeUpdate(), d.maxWidth = t, d.maxHeight = e, d.margins = B.extend({
                                    left: 0,
                                    right: 0,
                                    top: 0,
                                    bottom: 0
                                }, i), d.longestTextCache = d.longestTextCache || {}, d.beforeSetDimensions(), d.setDimensions(), d.afterSetDimensions(), d.beforeDataLimits(), d.determineDataLimits(), d.afterDataLimits(), d.beforeBuildTicks(), s = d.buildTicks() || [], d.afterBuildTicks(), d.beforeTickToLabelConversion(), a = d.convertTicksToLabels(s) || d.ticks, d.afterTickToLabelConversion(), o = 0, n = (d.ticks = a).length; o < n; ++o) r = a[o], (l = s[o]) ? l.label = r : s.push(l = {
                                label: r,
                                major: !1
                            });
                        ...
                        calculateTickRotation: function() {
                            ...
                            if (o.length && t.options.display && t.isHorizontal())
                                for (var r, s = B.longestText(e, n.font, o, t.longestTextCache), l = s, d = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; d < l && a < i.maxRotation;) {
                                    var c = B.toRadians(a);
                                    if (r = Math.cos(c), Math.sin(c) * s > t.maxHeight) {
                                        a--;
                                        break
                                    }
                                    a++, l = r * s
                        ...
                        fit: function() {
                            var t = this,
                                ...
                                l = t.isHorizontal(),
                                d = k(n),
                                c = o.gridLines.tickMarkLength;
                            if (e.width = l ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : s && r.drawTicks ? c : 0, e.height = l ? s && r.drawTicks ? c : 0 : t.maxHeight, a.display && s) {
                                var u = S(a) + B.options.toPadding(a.padding).height;
                                l ? e.height += u : e.width += u
                            }
                            if (n.display && s) {
                                var h = B.longestText(t.ctx, d.font, i, t.longestTextCache),
                                    f = B.numberOfLabelLines(i),
                                    p = .5 * d.size,
                                ...
                                if (l) {
                                    ...
                                    var m = B.toRadians(t.labelRotation),
                                        v = Math.cos(m),
                                        y = Math.sin(m) * h + d.size * f + p * (f - 1) + p;
                                    e.height = Math.min(t.maxHeight, e.height + y + g), t.ctx.font = d.font;
                                    var b = w(t.ctx, i[0], d.font),
                                        x = w(t.ctx, i[i.length - 1], d.font);
                                    0 !== t.labelRotation ? (t.paddingLeft = "bottom" === o.position ? v * b + 3 : v * p + 3, t.paddingRight = "bottom" === o.position ? v * p + 3 : v * x + 3) : (t.paddingLeft = b / 2 + 3, t.paddingRight = x / 2 + 3)
                                } else n.mirror ? h = 0 : h += g + p, e.width = Math.min(t.maxWidth, e.width + h), t.paddingTop = d.size / 2, t.paddingBottom = d.size / 2
                            }
                        ...
                        _autoSkip: function(t) {
                            var e, i, o, n, a = this,
                                ...
                                l = t.length,
                                d = B.toRadians(a.labelRotation),
                                c = Math.cos(d),
                                u = a.longestLabelWidth * c,
                                h = [];
                        ...
                        draw: function(T) {
                            ...
                            if (_.display) {
                                var n = M.ctx,
                                    ...
                                    $ = 0 !== M.labelRotation,
                                    D = M.isHorizontal(),
                                    O = A.autoSkip ? M._autoSkip(M.getTicks()) : M.getTicks(),
                                    a = B.valueOrDefault(A.fontColor, P.defaultFontColor),
                                    r = k(A),
                                    s = B.valueOrDefault(t.fontColor, P.defaultFontColor),
                                    l = k(t),
                                    L = I.drawTicks ? I.tickMarkLength : 0,
                                    i = B.valueOrDefault(e.fontColor, P.defaultFontColor),
                                    o = k(e),
                                    d = B.options.toPadding(e.padding),
                                    E = B.toRadians(M.labelRotation),
                                    z = [],
                                    F = "right" === _.position ? M.left : M.right - L,
                                    R = "right" === _.position ? M.left + L : M.right,
                                    j = "bottom" === _.position ? M.top : M.bottom - L,
                                    W = "bottom" === _.position ? M.top + L : M.bottom;
                                if (B.each(O, function(t, e) {
                                        if (!B.isNullOrUndef(t.label)) {
                                            var i, o, n, a, r, s, l, d, c, u, h, f, p, g, m = t.label;
                                            e === M.zeroLineIndex && _.offset === I.offsetGridLines ? (i = I.zeroLineWidth, o = I.zeroLineColor, n = I.zeroLineBorderDash, a = I.zeroLineBorderDashOffset) : (i = B.valueAtIndexOrDefault(I.lineWidth, e), o = B.valueAtIndexOrDefault(I.color, e), n = B.valueOrDefault(I.borderDash, P.borderDash), a = B.valueOrDefault(I.borderDashOffset, P.borderDashOffset));
                                            var v = "middle",
                                                y = "middle",
                                                b = A.padding;
                                            if (D) {
                                                var x = L + b;
                                                "bottom" === _.position ? (y = $ ? "middle" : "top", v = $ ? "right" : "center", g = M.top + x) : (y = $ ? "middle" : "bottom", v = $ ? "left" : "center", g = M.bottom - x);
                                                var w = H(M, e, I.offsetGridLines && 1 < O.length);
                                                w < M.left && (o = "rgba(0,0,0,0)"), w += B.aliasPixel(i), p = M.getPixelForTick(e) + A.labelOffset, r = l = c = h = w, s = j, d = W, u = T.top, f = T.bottom
                                            } else {
                                                var k, S = "left" === _.position;
                                                A.mirror ? (v = S ? "left" : "right", k = b) : (v = S ? "right" : "left", k = L + b), p = S ? M.right - k : M.left + k;
                                                var C = H(M, e, I.offsetGridLines && 1 < O.length);
                                        ...
                                        if (I.display && (n.save(), n.lineWidth = t.glWidth, n.strokeStyle = t.glColor, n.setLineDash && (n.setLineDash(t.glBorderDash), n.lineDashOffset = t.glBorderDashOffset), n.beginPath(), I.drawTicks && (n.moveTo(t.tx1, t.ty1), n.lineTo(t.tx2, t.ty2)), I.drawOnChartArea && (n.moveTo(t.x1, t.y1), n.lineTo(t.x2, t.y2)), n.stroke(), n.restore()), A.display) {
                                            ...
                                            var e = t.label;
                                            if (B.isArray(e))
                                                for (var i = 0, o = 0; i < e.length; ++i) n.fillText("" + e[i], 0, o), o += 1.5 * r.size;
                                    ...
                                    var c, u, h = 0,
                                        f = S(e) / 2;
                                    if (D) c = M.left + (M.right - M.left) / 2, u = "bottom" === _.position ? M.bottom - f - d.bottom : M.top + f + d.top;
                                    else {
                                        var p = "left" === _.position;
                                        c = p ? M.left + f + d.top : M.right - f - d.top, u = M.top + (M.bottom - M.top) / 2, h = p ? -.5 * Math.PI : .5 * Math.PI
                                    }
                                    n.save(), n.translate(c, u), n.rotate(h), n.textAlign = "center", n.textBaseline = "middle", n.fillStyle = i, n.font = o.font, n.fillText(e.labelString, 0, 0), n.restore()
                                }
                                if (I.drawBorder) {
                                    n.lineWidth = B.valueAtIndexOrDefault(I.lineWidth, 0), n.strokeStyle = B.valueAtIndexOrDefault(I.color, 0);
                                    var g = M.left,
                                        m = M.right,
                                        v = M.top,
                                        y = M.bottom,
                                        b = B.aliasPixel(n.lineWidth);
                                    D ? (v = y = "top" === _.position ? M.bottom : M.top, v += b, y += b) : (g = m = "left" === _.position ? M.right : M.left, g += b, m += b), n.beginPath(), n.moveTo(g, v), n.lineTo(m, y), n.stroke()
                                }
                            }
                        }
                    })
                ...
                e.exports = {
                    generators: {
                        linear: function(t, e) {
                            ...
                            if (t.stepSize && 0 < t.stepSize) i = t.stepSize;
                                ...
                                var n = c.niceNum(e.max - e.min, !1);
                                i = c.niceNum(n / (t.maxTicks - 1), !0)
                            }
                            var a = Math.floor(e.min / i) * i,
                                r = Math.ceil(e.max / i) * i;
                            t.min && t.max && t.stepSize && c.almostWhole((t.max - t.min) / t.stepSize, i / 1e3) && (a = t.min, r = t.max);
                            var s = (r - a) / i;
                            s = c.almostEquals(s, Math.round(s), i / 1e3) ? Math.round(s) : Math.ceil(s), o.push(void 0 !== t.min ? t.min : a);
                        ...
                        logarithmic: function(t, e) {
                            var i, o, n = [],
                                a = c.valueOrDefault,
                                r = a(t.min, Math.pow(10, Math.floor(c.log10(e.min)))),
                                s = Math.floor(c.log10(e.max)),
                                l = Math.ceil(e.max / Math.pow(10, s));
                            for (0 === r ? (i = Math.floor(c.log10(e.minNotZero)), o = Math.floor(e.minNotZero / Math.pow(10, i)), n.push(r), r = o * Math.pow(10, i)) : (i = Math.floor(c.log10(r)), o = Math.floor(r / Math.pow(10, i))); n.push(r), 10 === ++o && (o = 1, ++i), r = o * Math.pow(10, i), i < s || i === s && o < l;);
                            var d = a(t.max, r);
                            return n.push(d), n
                        }
                    },
                    formatters: {
                        ...
                        logarithmic: function(t, e, i) {
                            var o = t / Math.pow(10, Math.floor(c.log10(t)));
            ...
            35: [function(t, e, i) {
                ...
                o._set("global", {
                    ...
                    O.Tooltip = n.extend({
                        ...
                        update: function(t) {
                            var e, i, o, n, a, r, s, l, d, c, u, h, f, p, g, m, v, y, b, x = this,
                                w = x._options,
                                k = x._model,
                                S = x._model = L(w),
                                C = x._active,
                            ...
                            if (C.length) {
                                ...
                                var I = [],
                                    $ = [];
                                A = O.Tooltip.positioners[w.position].call(x, C, x._eventPosition);
                                var D = [];
                                ...
                                w.filter && (D = D.filter(function(t) {
                                    ...
                                    I.push(w.callbacks.labelColor.call(x, t, x._chart)), $.push(w.callbacks.labelTextColor.call(x, t, x._chart))
                                }), S.title = x.getTitle(D, T), S.beforeBody = x.getBeforeBody(D, T), S.body = x.getBody(D, T), S.afterBody = x.getAfterBody(D, T), S.footer = x.getFooter(D, T), S.x = Math.round(A.x), S.y = Math.round(A.y), S.caretPadding = w.caretPadding, S.labelColors = I, S.labelTextColors = $, S.dataPoints = D, M = function(t, e) {
                                    var i, o, n, a, r, s = t._model,
                                        l = t._chart,
                                    ...
                                    }, i(s.x) ? (c = "left", n(s.x) && (c = "center", u = r(s.y))) : o(s.x) && (c = "right", a(s.x) && (c = "center", u = r(s.y)));
                                    var p = t._options;
                                    return {
                                        xAlign: p.xAlign ? p.xAlign : c,
                                        yAlign: p.yAlign ? p.yAlign : u
                                    }
                                }(this, P = function(t, e) {
                                    var i = t._chart.ctx,
                                        o = 2 * e.yPadding,
                                    ...
                                    var s = e.title.length,
                                        ...
                                        c = e.bodyFontSize,
                                        u = e.footerFontSize;
                                    o += s * d, o += s ? (s - 1) * e.titleSpacing : 0, o += s ? e.titleMarginBottom : 0, o += r * c, o += r ? (r - 1) * e.bodySpacing : 0, o += l ? e.footerMarginTop : 0, o += l * u, o += l ? (l - 1) * e.footerSpacing : 0;
                                    var h = 0,
                                        f = function(t) {
                                            n = Math.max(n, i.measureText(t).width + h)
                                        };
                                    return i.font = E.fontString(d, e._titleFontStyle, e._titleFontFamily), E.each(e.title, f), i.font = E.fontString(c, e._bodyFontStyle, e._bodyFontFamily), E.each(e.beforeBody.concat(e.afterBody), f), h = e.displayColors ? c + 2 : 0, E.each(a, function(t) {
                                ...
                                }(this, S)), n = P, a = M, r = (o = S).x, s = o.y, l = o.caretSize, d = o.caretPadding, c = o.cornerRadius, u = a.xAlign, h = a.yAlign, f = l + d, p = c + d, "right" === u ? r -= n.width : "center" === u && (r -= n.width / 2), "top" === h ? s += f : s -= "bottom" === h ? n.height + f : n.height / 2, "center" === h ? "left" === u ? r += f : "right" === u && (r -= f) : "left" === u ? r -= p : "right" === u && (r += p), _ = {
                                    x: r,
                                    y: s
                                }
                            } else S.opacity = 0;
                        ...
                        getCaretPosition: function(t, e, i) {
                            var o, n, a, r, s, l, d = i.caretSize,
                                ...
                                g = e.width,
                                m = e.height;
                            if ("center" === h) s = p + m / 2, "left" === u ? (n = (o = f) - d, a = o, r = s + d, l = s - d) : (n = (o = f + g) + d, a = o, r = s - d, l = s + d);
                            else if (o = "left" === u ? (n = f + c + d) - d : "right" === u ? (n = f + g - c - d) - d : (n = f + g / 2) - d, a = n + d, "top" === h) s = (r = p) - d, l = r;
                            else {
                                s = (r = p + m) + d, l = r;
                                var v = a;
                                a = o, o = v
                        ...
                        drawBody: function(o, n, a, r) {
                            ...
                            i = d ? s + 2 : 0, E.each(t, function(t, e) {
                                var i = h(n.labelTextColors[e], r);
                                a.fillStyle = i, E.each(t.before, l), E.each(t.lines, function(t) {
                                    d && (a.fillStyle = h(n.legendColorBackground, r), a.fillRect(o.x, o.y, s, s), a.lineWidth = 1, a.strokeStyle = h(n.labelColors[e].borderColor, r), a.strokeRect(o.x, o.y, s, s), a.fillStyle = h(n.labelColors[e].backgroundColor, r), a.fillRect(o.x + 1, o.y + 1, s - 2, s - 2), a.fillStyle = i), l(t)
                                }), E.each(t.after, l)
            ...
            36: [function(t, e, i) {
                ...
                o._set("global", {
                    ...
                    inRange: function(t, e) {
                        var i = this._view;
                        if (i) {
                            for (var o = c.getAngleFromPoint(i, {
                                    x: t,
                                    y: e
                ...
                c._set("global", {
                    ...
                    draw: function(t) {
                        var e = this._view,
                            ...
                            l = u.color,
                            d = 0;
                        e.skip || (o.strokeStyle = e.borderColor || h, o.lineWidth = u.valueOrDefault(e.borderWidth, c.global.elements.point.borderWidth), o.fillStyle = e.backgroundColor || h, void 0 !== t && (i.x < t.left || 1.01 * t.right < i.x || i.y < t.top || 1.01 * t.bottom < i.y) && (i.x < t.left ? d = (r - i.x) / (t.left - i.x) : 1.01 * t.right < i.x ? d = (i.x - r) / (i.x - t.right) : i.y < t.top ? d = (s - i.y) / (t.top - i.y) : 1.01 * t.bottom < i.y && (d = (i.y - s) / (i.y - t.bottom)), d = Math.round(100 * d) / 100, o.strokeStyle = l(o.strokeStyle).alpha(d).rgbString(), o.fillStyle = l(o.fillStyle).alpha(d).rgbString()), u.canvas.drawPoint(o, n, a, r, s))
                    }
                })
            }, {
                25: 25,
            ...
            39: [function(t, e, i) {
                ...
                o._set("global", {
                    ...
                    draw: function() {
                        var t, e, i, o, n, a, r, s = this._chart.ctx,
                            l = this._view,
                            d = l.borderWidth;
                        if (l.horizontal ? (t = l.base, e = l.x, i = l.y - l.height / 2, o = l.y + l.height / 2, n = t < e ? 1 : -1, a = 1, r = l.borderSkipped || "left") : (t = l.x - l.width / 2, e = l.x + l.width / 2, n = 1, a = (i = l.y) < (o = l.base) ? 1 : -1, r = l.borderSkipped || "bottom"), d) {
                            var c = Math.min(Math.abs(t - e), Math.abs(i - o)),
                                u = (d = c < d ? c : d) / 2,
                                h = t + ("left" !== r ? u * n : 0),
                                f = e + ("right" !== r ? -u * n : 0),
                                p = i + ("top" !== r ? u * a : 0),
                    ...
                    drawPoint: function(t, e, i, o, n) {
                        ...
                        if (!e || "object" != typeof e || "[object HTMLImageElement]" !== (a = e.toString()) && "[object HTMLCanvasElement]" !== a) {
                            if (!(isNaN(i) || i <= 0)) {
                                switch (e) {
                                    default: t.beginPath(),
                                    t.arc(o, n, i, 0, 2 * Math.PI),
                                    t.closePath(),
                                    t.fill();
                                    break;
                                    case "triangle":
                                            t.beginPath(),
                                        d = (r = 3 * i / Math.sqrt(3)) * Math.sqrt(3) / 2,
                                        t.moveTo(o - r / 2, n + d / 3),
                                        t.lineTo(o + r / 2, n + d / 3),
                                        t.lineTo(o, n - 2 * d / 3),
                                        t.closePath(),
                                        t.fill();
                                        break;
                                    case "rect":
                                            c = 1 / Math.SQRT2 * i,
                                        t.beginPath(),
                                        t.fillRect(o - c, n - c, 2 * c, 2 * c),
                                        t.strokeRect(o - c, n - c, 2 * c, 2 * c);
                                        break;
                                    case "rectRounded":
                                            var u = i / Math.SQRT2,
                                            h = o - u,
            ...
            42: [function(t, e, i) {
                ...
                var o, c = {
                    ...
                    valueAtIndexOrDefault: function(t, e, i) {
                        return c.valueOrDefault(c.isArray(t) ? t[e] : t, i)
                    },
                    ...
                    each: function(t, e, i, o) {
                        ...
                        if (c.isArray(t))
                            ...
                            for (a = (r = Object.keys(t)).length, n = 0; n < a; n++) e.call(i, t[r[n]], r[n])
                    },
                    arrayEquals: function(t, e) {
                        var i, o, n, a;
                        if (!t || !e || t.length !== e.length) return !1;
                        for (i = 0, o = t.length; i < o; ++i)
                            if (n = t[i], a = e[i], n instanceof Array && a instanceof Array) {
                                if (!c.arrayEquals(n, a)) return !1
                    ...
                    clone: function(t) {
                        ...
                        if (c.isObject(t)) {
                            for (var e = {}, i = Object.keys(t), o = i.length, n = 0; n < o; ++n) e[i[n]] = c.clone(t[i[n]]);
                            return e
                        }
                        return t
                    },
                    _merger: function(t, e, i, o) {
                        var n = e[t],
                            a = i[t];
                        c.isObject(n) && c.isObject(a) ? c.merge(n, a, o) : e[t] = c.clone(a)
                    },
                    _mergerIf: function(t, e, i) {
                        var o = e[t],
                            n = i[t];
                        c.isObject(o) && c.isObject(n) ? c.mergeIf(o, n) : e.hasOwnProperty(t) || (e[t] = c.clone(n))
                    },
                    merge: function(t, e, i) {
                        var o, n, a, r, s, l = c.isArray(e) ? e : [e],
                            d = l.length;
                        if (!c.isObject(t)) return t;
                        for (o = (i = i || {}).merger || c._merger, n = 0; n < d; ++n)
                            if (e = l[n], c.isObject(e))
                                for (s = 0, r = (a = Object.keys(e)).length; s < r; ++s) o(a[s], t, e, i);
                        return t
                    },
                    ...
                    extend: function(i) {
                        for (var t = function(t, e) {
                                i[e] = t
                            }, e = 1, o = arguments.length; e < o; ++e) c.each(arguments[e], t);
                        return i
                    },
                    inherits: function(t) {
                        var e = this,
                        ...
                        return o.prototype = e.prototype, i.prototype = new o, i.extend = c.inherits, t && c.extend(i.prototype, t), i.__super__ = e.prototype, i
                    }
                };
                (e.exports = c).callCallback = c.callback, c.indexOf = function(t, e, i) {
                ...
                e.exports = {
                    ...
                    resolve: function(t, e, i) {
                        ...
                        for (o = 0, n = t.length; o < n; ++o)
                            if (void 0 !== (a = t[o]) && (void 0 !== e && "function" == typeof a && (a = a(e)), void 0 !== i && r.isArray(a) && (a = a[i]), void 0 !== a)) return a
                    }
                }
            }, {
                42: 42
            ...
            47: [function(t, e, i) {
                ...
                var f = t(45),
                    ...
                    y = ["animationstart", "webkitAnimationStart"],
                    s = {
                ...
                function n(e, t, i) {
                    var o, n, a, r, s, l, d, c, u = e[p] || (e[p] = {}),
                        h = u.resizer = function(t) {
                            var e = document.createElement("div"),
                                i = g + "size-monitor",
                                o = "position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;";
                            ...
                            return b(n, "scroll", r.bind(n, "expand")), b(a, "scroll", r.bind(a, "shrink")), e
                        }((a = !(o = function() {
                    ...
                    }, d = (s = e)[p] || (s[p] = {}), c = d.renderProxy = function(t) {
                        t.animationName === v && l()
                    }, f.each(y, function(t) {
                        b(s, t, c)
                    }), d.reflow = !!s.offsetParent, s.classList.add(m)
                }

                function a(t) {
                    var e, i, o, n = t[p] || {},
                        a = n.resizer;
                    delete n.resizer, i = (e = t)[p] || {}, (o = i.renderProxy) && (f.each(y, function(t) {
                        r(e, t, o)
                ...
                e.exports = {
                    ...
                    addEventListener: function(a, t, r) {
                        ...
                        if ("resize" !== t) {
                            var i = r[p] || (r[p] = {});
                            b(e, t, (i.proxies || (i.proxies = {}))[a.id + "_" + t] = function(t) {
                                var e, i, o, n;
            ...
            49: [function(t, e, i) {
                ...
                d._set("global", {
                    ...
                    function x(t, e, i, o, n) {
                        var a;
                        if (o && n) {
                            for (t.moveTo(e[0].x, e[0].y), a = 1; a < o; ++a) c.canvas.lineTo(t, e[a - 1], e[a]);
                            for (t.lineTo(i[n - 1].x, i[n - 1].y), a = n - 1; 0 < a; --a) c.canvas.lineTo(t, i[a], i[a - 1], !0)
                        }
                    }
                    return {
                        id: "filler",
                        afterDatasetsUpdate: function(t, e) {
                            var i, o, n, a, r, s, l, d = (t.data.datasets || []).length,
                                c = e.propagate,
                                u = [];
                            for (o = 0; o < d; ++o) a = null, (n = (i = t.getDatasetMeta(o)).dataset) && n._model && n instanceof m.Line && (a = {
                                visible: t.isDatasetVisible(o),
                                fill: f(n, o, d),
                                chart: t,
                                el: n
                            }), i.$filler = a, u.push(a);
                            for (o = 0; o < d; ++o)(a = u[o]) && (a.fill = g(u, o, c), a.boundary = p(a), a.mapper = (l = void 0, s = (r = a).fill, !(l = "dataset") === s ? null : (isFinite(s) || (l = "boundary"), h[l](r))))
                        },
                        beforeDatasetDraw: function(t, e) {
                            ...
                            if (i) {
                                var o = t.ctx,
                                    ...
                                    r = n._children || [],
                                    s = i.mapper,
                                    l = a.backgroundColor || d.global.defaultColor;
                                s && l && r.length && (c.canvas.clipArea(o, t.chartArea), function(t, e, i, o, n, a) {
                                    var r, s, l, d, c, u, h, f = e.length,
                                        p = o.spanGaps,
                                        g = [],
                                        m = [],
                                        v = 0,
                                        y = 0;
                                    for (t.beginPath(), r = 0, s = f + !!a; r < s; ++r) c = i(d = e[l = r % f]._view, l, o), u = b(d), h = b(c), u && h ? (v = g.push(d), y = m.push(c)) : v && y && (p ? (u && g.push(d), h && m.push(c)) : (x(t, g, m, v, y), v = y = 0, g = [], m = []));
                                    x(t, g, m, v, y), t.closePath(), t.fillStyle = n, t.fill()
                                }(o, r, s, a, l, n._loop), c.canvas.unclipArea(o))
                            }
                        }
                    }
                }
                    ...
                    return o.Legend = r.extend({
                        ...
                        fit: function() {
                            var o = this,
                                ...
                                i = _.global,
                                r = P.valueOrDefault,
                                s = r(n.fontSize, i.defaultFontSize),
                                l = r(n.fontStyle, i.defaultFontStyle),
                                d = r(n.fontFamily, i.defaultFontFamily),
                                c = P.fontString(s, l, d),
                                u = o.legendHitBoxes = [],
                                h = o.minSize,
                                f = o.isHorizontal();
                            if (f ? (h.width = o.maxWidth, h.height = e ? 10 : 0) : (h.width = e ? 10 : 0, h.height = o.maxHeight), e)
                                if (a.font = c, f) {
                                    var p = o.lineWidths = [0],
                                        g = o.legendItems.length ? s + n.padding : 0;
                                    a.textAlign = "left", a.textBaseline = "top", P.each(o.legendItems, function(t, e) {
                                    ...
                                    var m = n.padding,
                                        ...
                                        x = 0,
                                        w = s + m;
                                    P.each(o.legendItems, function(t, e) {
                                        var i = M(n, s) + s / 2 + a.measureText(t.text).width;
                                        x + w > h.height && (y += b + n.padding, v.push(b), x = b = 0), b = Math.max(b, i), x += w, u[e] = {
                                            left: 0,
                                            top: 0,
                                            width: i,
                                            height: s
                        ...
                        draw: function() {
                            ...
                            if (h.display) {
                                var y, b = u.ctx,
                                    ...
                                    o = P.fontString(w, e, i);
                                b.textAlign = "left", b.textBaseline = "middle", b.lineWidth = .5, b.strokeStyle = t, b.fillStyle = t, b.font = o;
                                var k = M(f, w),
                                    S = u.legendHitBoxes,
                                    C = u.isHorizontal();
                                y = C ? {
                                ...
                                var T = w + f.padding;
                                P.each(u.legendItems, function(t, e) {
                                    var i, o, n, a, r, s = b.measureText(t.text).width,
                                        l = k + w / 2 + s,
                                        d = y.x,
                                        c = y.y;
                                    C ? m <= d + l && (c = y.y += T, y.line++, d = y.x = u.left + (m - v[y.line]) / 2) : c + T > u.bottom && (d = y.x = d + u.columnWidths[y.line] + f.padding, c = y.y = u.top + f.padding, y.line++),
                                        function(t, e, i) {
                                            if (!(isNaN(k) || k <= 0)) {
                                                ...
                                                if (b.setLineDash && b.setLineDash(x(i.lineDash, g.borderDash)), h.labels && h.labels.usePointStyle) {
                                                    var n = w * Math.SQRT2 / 2,
                                                        a = n / Math.SQRT2,
                                                        r = t + a,
                                                        s = e + a;
                                                    P.canvas.drawPoint(b, i.pointStyle, n, r, s)
                                                } else o || b.strokeRect(t, e, k, w), b.fillRect(t, e, k, w);
                                                b.restore()
                                            }
                                        }(d, c, t), S[e].left = d, S[e].top = c, i = t, o = s, a = k + (n = w / 2) + d, r = c + n, b.fillText(i.text, a, r), i.hidden && (b.beginPath(), b.lineWidth = 2, b.moveTo(a, r), b.lineTo(a + o, r), b.stroke()), C ? y.x += l + f.padding : y.y += T
                                })
                            }
                        },
                        handleEvent: function(t) {
                        ...
                        beforeUpdate: function(t) {
                            var e = t.options.legend,
                                i = t.legend;
                            e ? (P.mergeIf(e, _.global.legend), i ? (n.configure(t, i, e), i.options = e) : a(t, e)) : i && (n.removeBox(t, i), delete t.legend)
                        },
                    ...
                    return o.Title = r.extend({
                        ...
                        fit: function() {
                            var t = k.valueOrDefault,
                                e = this.options,
                                i = e.display,
                                o = t(e.fontSize, w.global.defaultFontSize),
                                n = this.minSize,
                                a = k.isArray(e.text) ? e.text.length : 1,
                                r = k.options.toLineHeight(e.lineHeight, o),
                                s = i ? a * r + 2 * e.padding : 0;
                        ...
                        draw: function() {
                            var t = this.ctx,
                                ...
                                o = w.global;
                            if (i.display) {
                                var n, a, r, s = e(i.fontSize, o.defaultFontSize),
                                    l = e(i.fontStyle, o.defaultFontStyle),
                                    d = e(i.fontFamily, o.defaultFontFamily),
                                    c = k.fontString(s, l, d),
                                    u = k.options.toLineHeight(i.lineHeight, s),
                                    h = u / 2 + i.padding,
                                    f = 0,
                                    p = this.top,
                                    g = this.left,
                                    m = this.bottom,
                                    v = this.right;
                                t.fillStyle = e(i.fontColor, o.defaultFontColor), t.font = c, this.isHorizontal() ? (a = g + (v - g) / 2, r = p + h, n = v - g) : (a = "left" === i.position ? g + h : v - h, r = p + (m - p) / 2, n = m - p, f = Math.PI * ("left" === i.position ? -.5 : .5)), t.save(), t.translate(a, r), t.rotate(f), t.textAlign = "center", t.textBaseline = "middle";
                                var y = i.text;
                                if (k.isArray(y))
                                    for (var b = 0, x = 0; x < y.length; ++x) t.fillText(y[x], 0, b, n), b += u;
                                else t.fillText(y, 0, 0, n);
                                t.restore()
                            }
                        }
                    }), {
                ...
                e.exports = function(t) {
                    var e = t.Scale.extend({
                        ...
                        getPixelForValue: function(t, e) {
                            var i, o = this,
                                n = o.options.offset,
                                a = Math.max(o.maxIndex + 1 - o.minIndex - (n ? 0 : 1), 1);
                            ...
                            var d = o.height / a,
                                c = d * (e - o.minIndex);
                            return n && (c += d / 2), o.top + Math.round(c)
                        },
                        getPixelForTick: function(t) {
                        ...
                        i = t.LinearScaleBase.extend({
                            determineDataLimits: function() {
                                ...
                                if (void 0 === o && u.each(t, function(t, e) {
                                        if (!o) {
                                            ...
                                            l.isDatasetVisible(e) && d(i) && void 0 !== i.stack && (o = !0)
                                        }
                                    }), s.stacked || o) {
                                    var c = {};
                                    u.each(t, function(t, e) {
                                        var o = l.getDatasetMeta(e),
                                            i = [o.type, void 0 === s.stacked && void 0 === o.stack ? e : "", o.stack].join(".");
                                        void 0 === c[i] && (c[i] = {
                                            positiveValues: [],
                                            negativeValues: []
                                        });
                                        var n = c[i].positiveValues,
                                            a = c[i].negativeValues;
                                        l.isDatasetVisible(e) && d(o) && u.each(t.data, function(t, e) {
                            ...
                            getValueForPixel: function(t) {
                                var e = this.isHorizontal(),
                                    ...
                                    o = (e ? t - this.left : this.bottom - t) / i;
                                ...
                                if (void 0 === n && u.each(e, function(t, e) {
                                    ...
                                    u.each(e, function(t, e) {
                                        var n = l.getDatasetMeta(e),
                                            a = [n.type, void 0 === s.stacked && void 0 === n.stack ? e : "", n.stack].join(".");
                                        l.isDatasetVisible(e) && d(n) && (void 0 === c[a] && (c[a] = []), u.each(t.data, function(t, e) {
                                            var i = c[a],
                                                o = +r.getRightValue(t);
                ...
                e.exports = function(t) {
                    ...
                    function x(t) {
                        var e = t.options.pointLabels,
                            i = k.valueOrDefault(e.fontSize, y.defaultFontSize),
                            o = k.valueOrDefault(e.fontStyle, y.defaultFontStyle),
                            n = k.valueOrDefault(e.fontFamily, y.defaultFontFamily);
                        return {
                            size: i,
                            style: o,
                            family: n,
                            font: k.fontString(i, o, n)
                        }
                    }
                    ...
                    function w(t, e, i, o) {
                        if (k.isArray(e))
                            for (var n = i.y, a = 1.5 * o, r = 0; r < e.length; ++r) t.fillText(e[r], i.x, n), n += a;
                    ...
                    var i = t.LinearScaleBase.extend({
                        setDimensions: function() {
                            ...
                            var o = k.min([t.height, t.width]),
                                n = k.valueOrDefault(i.fontSize, y.defaultFontSize);
                        ...
                        getTickLimit: function() {
                            var t = this.options.ticks,
                                e = k.valueOrDefault(t.fontSize, y.defaultFontSize);
                        ...
                        fit: function() {
                            ...
                            this.options.pointLabels.display ? function(t) {
                                ...
                                var l, d, c, u = b(t);
                                for (e = 0; e < u; e++) {
                                    o = t.getPointPosition(e, a), l = t.ctx, d = n.size, c = t.pointLabels[e] || "", i = k.isArray(c) ? {
                                        w: k.longestText(l, l.font, c),
                                        h: c.length * d + 1.5 * (c.length - 1) * d
                                    } : {
                        ...
                        draw: function() {
                            ...
                            if (t.display) {
                                var d = a.ctx,
                                    ...
                                    u = l(s.fontSize, y.defaultFontSize),
                                    e = l(s.fontStyle, y.defaultFontStyle),
                                    i = l(s.fontFamily, y.defaultFontFamily),
                                    h = k.fontString(u, e, i);
                                k.each(a.ticks, function(t, e) {
                                    if (0 < e || s.reverse) {
                                        var i = a.getDistanceFromCenterForValue(a.ticksAsNumbers[e]);
                                        if (r.display && 0 !== e && function(t, e, i, o) {
                                                var n = t.ctx;
                                                if (n.strokeStyle = k.valueAtIndexOrDefault(e.color, o - 1), n.lineWidth = k.valueAtIndexOrDefault(e.lineWidth, o - 1), t.options.gridLines.circular) n.beginPath(), n.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI), n.closePath(), n.stroke();
                                                else {
                                                    var a = b(t);
                                                    if (0 === a) return;
                                                    n.beginPath();
                                            ...
                                            var o = l(s.fontColor, y.defaultFontColor);
                                            if (d.font = h, d.save(), d.translate(a.xCenter, a.yCenter), d.rotate(c), s.showLabelBackdrop) {
                                                var n = d.measureText(t).width;
                                                d.fillStyle = s.backdropColor, d.fillRect(-n / 2 - s.backdropPaddingX, -i - u / 2 - s.backdropPaddingY, n + 2 * s.backdropPaddingX, u + 2 * s.backdropPaddingY)
                                            }
                                            d.textAlign = "center", d.textBaseline = "middle", d.fillStyle = o, d.fillText(t, 0, -i), d.restore()
                                        }
                                    }
                                    ...
                                    var r, s, l, d, c = t.getDistanceFromCenterForValue(o.ticks.reverse ? t.min : t.max),
                                        u = x(t);
                                    e.textBaseline = "top";
                                    for (var h = b(t) - 1; 0 <= h; h--) {
                                        if (n.display) {
                                            var f = t.getPointPosition(h, c);
                                            e.beginPath(), e.moveTo(t.xCenter, t.yCenter), e.lineTo(f.x, f.y), e.stroke(), e.closePath()
                                        }
                                        if (a.display) {
                                            var p = t.getPointPosition(h, c + 5),
                                                g = i(a.fontColor, y.defaultFontColor);
                                            e.font = u.font, e.fillStyle = g;
                                            var m = t.getIndexAngle(h),
                                                v = k.toDegrees(m);
                                            e.textAlign = 0 === (d = v) || 180 === d ? "center" : d < 180 ? "left" : "right", r = v, s = t._pointLabelSizes[h], l = p, 90 === r || 270 === r ? l.y -= s.h / 2 : (270 < r || r < 90) && (l.y -= s.h), w(e, t.pointLabels[h] || "", p, u.size)
                                        }
                                    }
                                }(a)
                            }
            ...
            57: [function(t, e, i) {
                ...
                function k(t, e, i, o) {
                    var n = function(t, e, i) {
                            for (var o, n, a, r = 0, s = t.length - 1; 0 <= r && r <= s;) {
                                if (n = t[(o = r + s >> 1) - 1] || null, a = t[o], !n) return {
                                    lo: null,
                                    hi: a
                                };
                                if (a[e] < i) r = o + 1;
                        ...
                        a = n.lo ? n.hi ? n.lo : t[t.length - 2] : t[0],
                        r = n.lo ? n.hi ? n.hi : t[t.length - 1] : t[1],
                        s = r[e] - a[e],
                        l = s ? (i - a[e]) / s : 0,
                        d = (r[o] - a[o]) * l;
                    return a[o] + d
                ...
                function s(t, e) {
                    var i = e.parser,
                        o = e.parser || e.format;
                    return "function" == typeof i ? i(t) : "string" == typeof t && "string" == typeof o ? b(t, o) : (t instanceof b || (t = b(t)), t.isValid() ? t : "function" == typeof o ? o(t) : t)
                }

                function S(t, e) {
                    if (m.isNullOrUndef(t)) return null;
                    var i = e.options.time,
                        o = s(e.getRightValue(t), i);
                    return o.isValid() ? (i.round && o.startOf(i.round), o.valueOf()) : null
                }

                function C(t) {
                    for (var e = w.indexOf(t) + 1, i = w.length; e < i; ++e)
                        if (x[w[e]].common) return w[e]
                }

                function T(t, e, i, o) {
                    var n, a = o.time,
                        r = a.unit || function(t, e, i, o) {
                            var n, a, r, s = w.length;
                            for (n = w.indexOf(t); n < s - 1; ++n)
                                if (r = (a = x[w[n]]).steps ? a.steps[a.steps.length - 1] : g, a.common && Math.ceil((i - e) / (r * a.size)) <= o) return w[n];
                            return w[s - 1]
                        }(a.minUnit, t, e, i),
                        s = C(r),
                        l = m.valueOrDefault(a.stepSize, a.unitStepSize),
                        d = "week" === r && a.isoWeekday,
                    ...
                    for (l || (l = function(t, e, i, o) {
                            var n, a, r, s = e - t,
                                ...
                                d = l.size,
                                c = l.steps;
                            if (!c) return Math.ceil(s / ((o || 1) * d));
                            for (n = 0, a = c.length; n < a && (r = c[n], !(Math.ceil(s / (d * r)) <= o)); ++n);
                            return r
                        }(t, e, r, i)), d && (h = h.isoWeekday(d), f = f.isoWeekday(d)), h = h.startOf(d ? "day" : r), (f = f.startOf(d ? "day" : r)) < e && f.add(1, r), n = b(h), c && s && !d && !a.round && (n.startOf(s), n.add(~~((h - n) / (u.size * l)) * l, r)); n < f; n.add(l, r)) p.push(+n);
                    return p.push(+n), p
                }
                e.exports = function(e) {
                    var t = e.Scale.extend({
                        ...
                        determineDataLimits: function() {
                            ...
                            for (t = 0, i = (s.data.datasets || []).length; t < i; ++t)
                                if (s.isDatasetVisible(t))
                                    if (n = s.data.datasets[t].data, m.isObject(n[0]))
                                        for (h[t] = [], e = 0, o = n.length; e < o; ++e) a = S(n[e], r), u.push(a), h[t][e] = a;
                                    else u.push.apply(u, f), h[t] = f.slice(0);
                            else h[t] = [];
                            f.length && (f = y(f).sort(v), d = Math.min(d, f[0]), c = Math.max(c, f[f.length - 1])), u.length && (u = y(u).sort(v), d = Math.min(d, u[0]), c = Math.max(c, u[u.length - 1])), d = S(l.min, r) || d, c = S(l.max, r) || c, d = d === g ? +b().startOf("day") : d, c = c === p ? +b().endOf("day") + 1 : c, r.min = Math.min(d, c), r.max = Math.max(d + 1, c), r._horizontal = r.isHorizontal(), r._table = [], r._timestamps = {
                                data: u,
                                datasets: h,
                                labels: f
                            }
                        ...
                        buildTicks: function() {
                            var t, e, i, o, n, a, r, s, l, d, c, u, h = this,
                                f = h.min,
                                p = h.max,
                                g = h.options,
                                m = g.time,
                            ...
                            for ("ticks" === g.bounds && v.length && (f = v[0], p = v[v.length - 1]), f = S(m.min, h) || f, p = S(m.max, h) || p, t = 0, e = v.length; t < e; ++t) f <= (i = v[t]) && i <= p && y.push(i);
                            return h.min = f, h.max = p, h._unit = m.unit || function(t, e, i, o) {
                                    var n, a, r = b.duration(b(o).diff(b(i)));
                                    for (n = w.length - 1; n >= w.indexOf(e); n--)
                                        if (a = w[n], x[a].common && r.as(a) >= t.length) return a;
                                    return w[e ? w.indexOf(e) : 0]
                                }(y, m.minUnit, h.min, h.max), h._majorUnit = C(h._unit), h._table = function(t, e, i, o) {
                                    if ("linear" === o || !t.length) return [{
                                        time: e,
                                        pos: 0
                                    }, {
                                        time: i,
                                    ...
                                    var n, a, r, s, l, d = [],
                                        c = [e];
                                    for (n = 0, a = t.length; n < a; ++n) e < (s = t[n]) && s < i && c.push(s);
                                    for (c.push(i), n = 0, a = c.length; n < a; ++n) l = c[n + 1], r = c[n - 1], s = c[n], void 0 !== r && void 0 !== l && Math.round((l + r) / 2) === s || d.push({
                                        time: s,
                                        pos: n / (a - 1)
                                    });
                                    return d
                                }(h._timestamps.data, f, p, g.distribution), h._offsets = (o = h._table, n = y, a = f, r = p, u = c = 0, (s = g).offset && n.length && (s.time.min || (l = 1 < n.length ? n[1] : r, d = n[0], c = (k(o, "time", l, "pos") - k(o, "time", d, "pos")) / 2), s.time.max || (l = n[n.length - 1], d = 1 < n.length ? n[n.length - 2] : a, u = (k(o, "time", l, "pos") - k(o, "time", d, "pos")) / 2)), {
                                    left: c,
                                    right: u
                                }),
                                function(t, e) {
                                    var i, o, n, a, r = [];
                                    for (i = 0, o = t.length; i < o; ++i) n = t[i], a = !!e && n === +b(n).startOf(e), r.push({
                                        value: n,
                                        major: a
                                    });
                                    return r
                        ...
                        getLabelForIndex: function(t, e) {
                            var i = this.chart.data,
                                o = this.options.time,
                                n = i.labels && t < i.labels.length ? i.labels[t] : "",
                        ...
                        convertTicksToLabels: function(t) {
                            var e, i, o = [];
                            for (e = 0, i = t.length; e < i; ++e) o.push(this.tickFormatFunction(b(t[e].value), e, t));
                            return o
                        },
                        ...
                        getValueForPixel: function(t) {
                            var e = this,
                                i = e._horizontal ? e.width : e.height,
                                o = e._horizontal ? e.left : e.top,
                                n = (i ? (t - o) / i : 0) * (e._offsets.left + 1 + e._offsets.left) - e._offsets.right,
                                a = k(e._table, "pos", n, "time");
                            return b(a)
                        },
                        getLabelWidth: function(t) {
                            var e = this.options.ticks,
                                i = this.ctx.measureText(t).width,
                                o = m.toRadians(e.maxRotation),
                                n = Math.cos(o),
                                a = Math.sin(o);
                        ...
                        getLabelCapacity: function(t) {
                            var e = this.options.time.displayFormats.millisecond,
                                i = this.tickFormatFunction(b(t), 0, [], e),
    ...
    function(f) {
        ...
        Object.keys || (Object.keys = function() {
            ...
            return function(t) {
                ...
                if (a)
                    for (i = 0; i < s; i++) n.call(t, r[i]) && o.push(r[i]);
                return o
            }
        }());
        var x = !1;
        location.hash;
        var w = ["Days", "Hours", "Minutes", "Seconds"],
            o = {
                Seconds: "Minutes",
                Minutes: "Hours",
                Hours: "Days",
        ...
        function S(t, e, i, o, n) {
            for (var a = {}, r = {}, s = {}, l = {}, d = {}, c = {}, u = null, h = 0; h < o.length; h++) {
                var f, p = o[h];
                f = null === u ? i / k[p] : k[u] / k[p];
                var g = t / k[p],
                    m = e / k[p];
                n && (g = 0 < g ? Math.floor(g) : Math.ceil(g), m = 0 < m ? Math.floor(m) : Math.ceil(m)), "Days" !== p && (g %= f, m %= f), a[p] = g, s[p] = Math.abs(g), r[p] = m, c[p] = Math.abs(m), l[p] = Math.abs(g) / f, d[p] = Math.abs(m) / f, u = p
            }
            return {
                raw_time: a,
                raw_old_time: r,
        ...
        function n() {
            void 0 !== b.TC_Instance_List ? r = b.TC_Instance_List : b.TC_Instance_List = r,
                function(r) {
                    ...
                    r.requestAnimationFrame && r.cancelAnimationFrame || (r.requestAnimationFrame = function(t, e, i) {
                        ...
                        var o = (new Date).getTime(),
                            n = Math.max(0, 16 - (o - i.data.last_frame)),
        ...
        s.prototype.clearListeners = function() {
            ...
            for (var l in this.data.text_elements)
                if (this.config.time[l].show) {
                    var d = f("<div>");
                    d.addClass("textDiv_" + l), d.css("top", Math.round(.35 * this.data.attributes.item_size)), d.css("left", Math.round(e++ * this.data.attributes.item_size)), d.css("width", this.data.attributes.item_size), d.appendTo(this.container);
                    var c = f("<h4>");
                    c.text(this.config.time[l].text), c.css("font-size", Math.round(this.config.text_size * this.data.attributes.item_size)), c.appendTo(d);
                    var u = f("<span>");
                    u.css("font-size", Math.round(this.config.number_size * this.data.attributes.item_size)), u.appendTo(d), this.data.text_elements[l] = u
                }
            ...
            if (this.data.prev_time = n, null === o && (o = n), !this.config.count_past_zero && n > this.data.attributes.ref_date) {
                for (var a = 0; a < this.data.drawn_units.length; a++) {
                    ...
                    var s = a * this.data.attributes.item_size + this.data.attributes.item_size / 2,
                        l = this.data.attributes.item_size / 2,
                        d = this.config.time[r].color;
                    this.drawArc(s, l, d, 0)
                }
                this.stop()
            } else {
                e = (this.data.attributes.ref_date - n) / 1e3, i = (this.data.attributes.ref_date - o) / 1e3;
                var c = "smooth" !== this.config.animation,
                    u = S(e, i, this.data.total_duration, this.data.drawn_units, c),
                    h = S(e, i, k.Years, w, c),
                    f = (a = 0, 0),
                    p = null,
                ...
                for (var a in w) {
                    ...
                    if (Math.floor(h.raw_time[r]) !== Math.floor(h.raw_old_time[r]) && this.notifyListeners(r, Math.floor(h.time[r]), Math.floor(e), "all"), !(g.indexOf(r) < 0)) {
                        if (Math.floor(u.raw_time[r]) !== Math.floor(u.raw_old_time[r]) && this.notifyListeners(r, Math.floor(u.time[r]), Math.floor(e), "visible"), !t) {
                            ...
                            s = f * this.data.attributes.item_size + this.data.attributes.item_size / 2, l = this.data.attributes.item_size / 2, d = this.config.time[r].color;
                            "smooth" === this.config.animation ? (null === p || x || (Math.floor(u.time[p]) > Math.floor(u.old_time[p]) ? (this.radialFade(s, l, d, 1, r), this.data.state.fading[r] = !0) : Math.floor(u.time[p]) < Math.floor(u.old_time[p]) && (this.radialFade(s, l, d, 0, r), this.data.state.fading[r] = !0)), this.data.state.fading[r] || this.drawArc(s, l, d, u.pct[r])) : this.animateArc(s, l, d, u.pct[r], u.old_pct[r], (new Date).getTime() + 200)
                        }
                        p = r, f++
                    }
                }
                if (!this.data.paused && !t) {
                    ...
                    if ("smooth" === this.config.animation) this.data.animation_frame = b.requestAnimationFrame(v, m.element, m);
                    else {
                        var y = e % 1 * 1e3;
                        y < 0 && (y = 1e3 + y), y += 50, m.data.animation_frame = b.setTimeout(function() {
                            m.data.animation_frame = b.requestAnimationFrame(v, m.element, m)
                        }, y)
                    }
                }
            }
            ...
            if (null !== this.data.attributes.context) {
                var r = n - o;
                if (.5 < Math.abs(r)) 0 === o ? this.radialFade(t, e, i, 1) : this.radialFade(t, e, i, 0);
                else {
            ...
            if (null !== this.data.attributes.context) {
                ...
                var l = -.5 * Math.PI,
                    d = 2 * Math.PI;
                n = l + this.config.start_angle / 360 * d;
                var c = 2 * o * Math.PI;
                "Both" === this.config.direction ? (r = !1, a = (n -= c / 2) + c) : "Clockwise" === this.config.direction ? (r = !1, a = n + c) : (r = !0, a = n - c), this.data.attributes.context.beginPath(), this.data.attributes.context.arc(t, e, this.data.attributes.radius, n, a, r), this.data.attributes.context.lineWidth = this.data.attributes.line_width, this.data.attributes.context.strokeStyle = i, this.data.attributes.context.stroke()
            }
            ...
            void 0 !== typeof e && b.setTimeout(function() {
            ...
            this.clearListeners(), this.stop(), b.clearInterval(this.data.interval_fallback), this.data.interval_fallback = null, this.container.remove(), f(this.element).removeAttr("data-tc-id"), f(this.element).removeData("tc-id")
        }, s.prototype.setOptions = function(t) {
            if (null === this.config && (this.default_options.ref_date = new Date, this.config = f.extend(!0, {}, this.default_options)), f.extend(!0, this.config, t), b = this.config.use_top_frame ? window.top : window, n(), this.data.total_duration = this.config.total_duration, "string" == typeof this.data.total_duration)
                if (void 0 !== k[this.data.total_duration]) this.data.total_duration = k[this.data.total_duration];
    ...
    function(y) {
        ...
        var e, b = y(window),
            ...
            w = (y(t), window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
                setTimeout(t, 1e3 / 60)
            });
        new LazyLoad({
        ...
        AOS.init({
            ...
            var t, e, i, o, n, a, r, s, l, d, c, u, h, f, p, g, m, v;
            t = document.getElementById("top-bar"), e = document.getElementById("top-bar__navigation-toggler"), i = document.getElementById("top-bar__navigation"), o = y(t), n = y(e), a = y(i), r = a.find("li a"), 0 < (s = a.find(".submenu")).length && s.parent("li").addClass("has-submenu"), 0 === y("#start-screen").length && y("#intro"), r.on("touchend click", function(t) {
                    var e = y(this),
                        i = e.parent();
                ...
                function() {
                    var t = document.getElementById("top-bar__choose-lang"),
                        n = y(t);
                    if (0 < n.length) {
                        var a = n.find(".img--active"),
                            r = n.find(".list"),
                            e = r.children("li");
                ...
                }(), 0 < (l = y(".start-screen__slider")).length && l.slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    speed: 1e3,
                ...
                }), 0 < (d = y(".posts--slider")).length && d.slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    speed: 800,
                ...
                }), 0 < (c = y(".testimonial--slider")).length && c.slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    speed: 800,
                    ...
                    prevArrow: '<i class="fontello-left-open slick-prev"></i>',
                    nextArrow: '<i class="fontello-right-open slick-next"></i>'
                }), 0 < (u = y(".review--slider")).length && u.slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    speed: 800,
                ...
                }), 0 < (h = y(".word-rotating--slider")).length && h.slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    speed: 800,
                    ...
                    prevArrow: '<i class="fontello-left-open slick-prev"></i>',
                    nextArrow: '<i class="fontello-right-open slick-next"></i>'
                }), 0 < (f = y(".screenshots--slider")).length && f.slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    speed: 800,
                ...
                }), 0 < (p = y(".feature--slider")).length && p.slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    speed: 800,
                    ...
                    nextArrow: '<i class="fontello-right-open slick-next"></i>',
                    responsive: []
                }), 0 < (g = y(".projects--slider")).length && g.slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    speed: 800,
                ...
                }), 0 < (m = y(".events--slider")).length && m.slick({
                    autoplay: !0,
                    autoplaySpeed: 3e3,
                    adaptiveHeight: !0,
                    speed: 800,
                ...
                }), 0 < y("a[data-fancybox]").length && y("[data-fancybox]").fancybox({
                ...
                function() {
                    var t = y(".accordion-container");
                    if (0 < t.length) {
                        var n = t.find(".accordion-item"),
                            e = t.find(".accordion-toggler");
                        t.each(function() {
                            y(this).find(".accordion-item:eq(0)").addClass("active")
                        }), e.on("click", function(t) {
                            t.preventDefault();
                            var e = y(this),
                                i = e.parent(),
                ...
                function() {
                    var t = y(".tab-container");
                    if (0 < t.length) {
                        var n = t.find("nav a");
                        t.each(function() {
                            y(this).find("nav a:eq(0)").addClass("active").end().find(".tab-content__item:eq(0)").addClass("is-visible")
                ...
                }(), y('a[href*="#"]').not('[href="#"]').not('[href="#0"]').on("touchend click", function(t) {
                    if ($this = y(this), _offset = 135, location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                        var e = y(this.hash);
                        return (e = e.length ? e : y("[name=" + this.hash.slice(1) + "]")).length && y("html,body").stop().animate({
                            scrollTop: e.offset().top - _offset
                        }, 1e3), !1
                    }
                }),
                function() {
                    ...
                    if (0 < e.length) {
                        ...
                        o.on("click", function(t) {
                            return t.preventDefault(), y("body,html").stop().animate({
                                scrollTop: 0
                            }, 1500), !1
                        }), b.on("scroll", function(t) {
                            b.scrollTop() > o.data("visible-offset") ? e.is(":hidden") && e.fadeIn() : e.is(":visible") && e.fadeOut()
                        })
                    }
                }(),
                function() {
                ...
                function() {
                    ...
                    0 < t.length && (e(), b.on("scroll", function(t) {
                        w ? w(function() {
                            e()
                        }) : e()
                    }))
                }(), objectFitImages(), 0 < (v = y(".js-contact-form")).length && v.each(function() {
                    y(this).on("submit", function() {
                        var e = y(this),
                            t = e.serialize(),
                            i = e.find(".form__note");
                        return y.ajax({
                ...
                }), 0 < y(".js-select").length && y(".js-select").niceSelect()
        }), b.on("load", function() {
            var t = y(".js-masonry");
        ...
        }), y.fn.is_on_screen = function() {
            var t = {
                top: b.scrollTop(),
                left: b.scrollLeft()
            };
            t.right = t.left + b.width(), t.bottom = t.top + b.height();
            var e = this.offset();
